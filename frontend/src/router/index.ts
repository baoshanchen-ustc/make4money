...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/recharge/success/:orderNo',
    name: 'RechargeSuccess',
    component: () => import('@/views/user/RechargeSuccessView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: false,
      requiresRecharge: true,
      title: 'Recharge Success',
      titleKey: 'recharge.successTitle',
      descriptionKey: 'recharge.successSubtitle'
    }
  },
  {
    path: '/recharge/failed/:orderNo',
    name: 'RechargeFailed',
    component: () => import('@/views/user/RechargeFailedView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: false,
      requiresRecharge: true,
      title: 'Recharge Failed',
      titleKey: 'recharge.failedTitle',
