...
export interface SystemSettings {
  ...
  default_settings_linuxdo_overridden: boolean;
  default_settings_wechat: ProviderDefaultUserSettings;
  default_settings_wechat_overridden: boolean;
  default_settings_oidc: ProviderDefaultUserSettings;
  default_settings_oidc_overridden: boolean;
  // OEM settings
  site_name: string;
  site_logo: string;
  ...
  wechat_login_open_app_secret_configured: boolean;
  wechat_login_mp_enabled: boolean;
  wechat_login_mp_app_id: string;
  wechat_login_mp_app_secret_configured: boolean;
