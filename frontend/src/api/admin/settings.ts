...
export interface SystemSettings {
  ...
  account_default_rpm: number;
  ltb_ttl_days: number;
  ltb_cleanup_interval_seconds: number;
  session_account_fanout_limit: number;
  session_account_fanout_window_sec: number;
  bound_session_switch_jitter_min_ms: number;
  bound_session_switch_jitter_max_ms: number;
