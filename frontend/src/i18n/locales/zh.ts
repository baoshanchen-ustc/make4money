export default {
  ...
  admin: {
    ...
    proxies: {
      ...
      subscriptionImportTitle: '通过订阅导入 SS 代理',
      subscriptionImportHint: '输入公开的代理订阅地址，系统会解析其中支持的 SS 节点，并复用现有批量导入流程创建代理。',
      subscriptionImportNote: '当前仅支持 SS 节点；带 plugin 的 SS 节点以及其他协议会被自动跳过。',
      ...
      subscriptionImportParsed: '解析到 {count} 个可导入的 SS 代理',
      subscriptionImportSelected: '已选择 {count} / {total} 个节点',
      subscriptionImportSelectHint: '选择需要导入的节点，默认全部勾选。',
      subscriptionImportSearchPlaceholder: '按节点名称搜索',
      subscriptionImportSelectAll: '全选',
      subscriptionImportClearSelection: '清空选择',
      subscriptionImportNoMatch: '没有匹配的节点',
      subscriptionImportPreviewMore: '其余 {count} 个节点未展开显示',
      subscriptionImportButton: '导入已选 {count} 个代理',
      subscriptionImportFailed: '订阅解析失败',
      subscriptionImportEmpty: '请先解析出可导入的代理',
      subscriptionImportSelectionEmpty: '请至少选择一个要导入的代理',
      dataExport: '导出',
      ...
      ssMethodRequired: 'Shadowsocks 代理必须填写加密方式',
      ssPasswordRequired: 'Shadowsocks 代理必须填写密码',
      status: '状态',
      ...
      batchInputHint: "支持 http、https、socks5、socks5h、ss 协议，格式：协议://[用户名:密码{'@'}]主机:端口",
