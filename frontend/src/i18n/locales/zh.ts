  ...
  admin: {
    ...
    settings: {
      ...
      betaPolicy: {
        ...
        presetCompatWarning: '⚠ 兼容预设会让 fast-mode-2026-02-01、context-1m-2025-08-07 等 Claude Code 较新 beta 透传至上游，**包括它们的 Filter 与 Block 规则都会被跳过**：你之前显式配置的 block 在切到兼容预设后会失效。可能产生额外 priority 配额或 1M context 成本，仅在确认账号配额可承受时启用。'
      },
      openaiFastPolicy: {
