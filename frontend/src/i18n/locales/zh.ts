export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      vertexServiceAccountJsonHint: '从 GCP Console 下载的 Service Account 密钥 JSON（粘贴整段，将以加密方式存储）',
      vertexServiceAccountJsonRequired: '请填写 Service Account JSON',
      vertexServiceAccountJsonInvalid: 'Service Account JSON 格式不正确',
      vertexProjectId: 'GCP Project ID',
      vertexProjectIdHint: 'GCP 项目 ID（通常与 SA JSON 中的 project_id 一致）',
      vertexProjectIdRequired: '请填写 GCP Project ID',
      vertexRegion: 'Region',
      vertexRegionHint: 'Vertex AI 区域；不同模型可用区域不同（参考 GCP 文档）。global 表示多区域路由',
