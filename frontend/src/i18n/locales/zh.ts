export default {
  ...
  auth: {
    ...
    passkeyLoginFailed: '通行密钥登录失败，请重试或使用其他方式。',
  ...
  profile: {
    ...
    totp: {
      ...
      removeEmail: '移除',
	    ...
	    passkey: {
	      title: '通行密钥 (Passkeys)',
	      description: '使用指纹、面容或屏幕锁安全登录',
	      featureDisabled: '功能未开放',
	      featureDisabledHint: '管理员尚未开放通行密钥功能',
	      recentAuthRequired: '需要重新验证',
	      recentAuthRequiredHint: '请退出并重新登录以管理您的通行密钥',
	      noPasskeys: '暂无通行密钥',
	      noPasskeysHint: '添加通行密钥以实现无密码登录',
	      addPasskey: '添加通行密钥',
	      synced: '已同步',
	      backupEligible: '可备份',
	      createdAt: '创建时间',
	      ...
	      renameTitle: '重命名通行密钥',
	      friendlyName: '名称',
	      friendlyNamePlaceholder: '例如：我的 iPhone',
	      renameSuccess: '通行密钥重命名成功',
	      renameFailed: '重命名通行密钥失败',
	      revokeTitle: '撤销通行密钥',
	      revokeWarning: '您确定要撤销通行密钥 "{name}" 吗？撤销后将无法使用它进行登录。',
	      confirmRevoke: '确认撤销',
	      revokeSuccess: '通行密钥已撤销',
	      revokeFailed: '撤销通行密钥失败',
	      enrollSuccess: '通行密钥添加成功',
	      enrollFailed: '添加通行密钥失败'
	    }
	  },
  ...
  admin: {
    ...
    settings: {
      ...
      passkey: {
        title: 'Passkey 登录',
        description: '使用 WebAuthn 和当前站点身份配置 Passkey 登录。',
        enable: 'Passkey 登录',
        enableHint: '允许用户使用 Passkey 登录。WebAuthn 配置会自动从前端地址推导。',
        configInvalidTitle: 'Passkey 配置需要处理',
        configInvalidFallback: 'Passkey 已启用，但当前 Relying Party 配置无效。',
        derivedHint: '此处的 Passkey Relying Party 配置为只读，并会自动根据前端地址生成。',
        rpId: 'Relying Party ID',
        rpIdHint: '根据前端地址自动生成，并作为 WebAuthn 的 relying party 标识。',
        rpName: 'Relying Party 名称',
        rpNameHint: '根据站点名称自动生成，并在浏览器或认证器的 Passkey 流程中显示。',
        allowedOrigins: '允许的 Origin',
        allowedOriginsHint: '根据前端地址自动生成。浏览器实际访问的 origin 必须与其中之一完全一致。',
        unresolved: '尚未解析'
      },
      turnstile: {
