export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      createAccount: '添加账号',
      codexBulk: {
        openButton: '批量添加 Codex',
        title: '批量添加 Codex 账号',
        intro: '面向大批量 Codex 账号导入场景。系统会先校验 RT，再按代理池自动分配，默认每 4 个账号使用 1 个代理。',
        batchId: '批次号',
        batchIdHint: '会写入账号名和批次元数据，便于后续搜索与运维。',
        nameTemplate: '名称模板',
        nameTemplateHint: '支持 {batch} 和 {index} 占位符；如果未写 {index}，系统会自动补序号。',
        accountsPerProxy: '每个代理分配账号数',
        accountsPerProxyHint: '默认 4。系统会按当前账号占用数计算可用槽位。',
        concurrency: '并发数',
        priority: '优先级',
        rateMultiplier: '账号倍率',
        notes: '备注',
        notesPlaceholder: '例如：202603 批量导入 / 东京代理池',
        groups: '分组',
        proxyPool: '代理池',
        proxyPoolRequired: '请至少选择一个代理',
        failedToLoadProxies: '加载代理池失败',
        selectedProxyCount: '已选代理',
        eligibleProxyCount: '可用代理',
        estimatedCapacity: '预计容量',
        allocatableIpsTitle: '可分配 IP',
        allocatableIpsHint: '仅展示当前可用且仍可继续分配账号的代理。',
        selectedCapacity: '当前选中代理预计可创建 {count} 个账号',
        selectEligible: '选择全部可用代理',
        eligible: '可用',
        unavailable: '不可用',
        accountCount: '当前账号数 {count}',
        allocatableCapacity: '可分配 {count}',
        noAllocatableIps: '当前没有可分配的 IP',
        qualityGrade: '质量 {grade} / {score}',
        latencyStatus: '延迟状态 {status}',
        noProxies: '暂无可展示的代理',
        refreshTokens: 'Refresh Token',
        refreshTokensPlaceholder: '每行一个 RT，支持粘贴 100 行或上传 txt/csv 文件',
        refreshTokensRequired: '请至少输入一个 Refresh Token',
        uploadFile: '上传文件',
        failedToReadFile: '读取文件失败',
        parsedCount: '已解析 {count} 个 RT',
        resultTitle: '导入结果',
        resultCreated: '已创建',
        previewButton: '预检',
        previewing: '预检中...',
        previewTitle: '预检结果',
        previewRequested: '请求数',
        previewReady: '可创建',
        previewFailedLabel: '失败',
        previewRemainingCapacity: '剩余容量',
        previewReadyToast: '预检完成：可创建 {ready} 个，失败 {failed} 个',
        previewFailedError: '预检失败',
        previewRequired: '请先完成最新一次预检',
        previewOutdated: '表单内容已变更，请重新执行预检后再导入。',
        proxyAllocation: '代理分配',
        proxyAllocationLine: '本批分配 {assigned} 个，当前 {current} 个，导入后 {total} 个',
        itemResults: '逐条结果',
        importButton: '开始导入',
        importing: '导入中...',
        importDoneToast: '导入完成：创建 {created} 个，失败 {failed} 个',
        importFailed: '批量导入失败'
      },
      autoRefresh: '自动刷新',
