export default {
  ...
  admin: {
    ...
    settings: {
      ...
      extremePerformance: {
        title: '极致性能模式',
        description: '在保留原功能的前提下，关闭后台账号列表的自动用量请求，并为后续热池调度提供统一配置入口。',
        enabled: '启用极致性能模式',
        enabledHint: '开启后，后台管理页和调度层会逐步切换到轻量化/热池模式。',
        disableAutoUsageFetch: '禁止自动刷新用量窗口',
        disableAutoUsageFetchHint: '账号列表页不再自动请求 /usage，由手动操作按需触发。',
        disableAutoTodayStatsFetch: '禁止自动刷新今日统计',
        disableAutoTodayStatsFetchHint: '账号列表页不再自动请求 /today-stats/batch。',
        allowManualUsageFetch: '允许手动查看用量',
        allowManualUsageFetchHint: '保留单账号手动查看 usage 的能力，不阉割原功能。',
        openaiHotPool: 'OpenAI 热池上限',
        geminiHotPool: 'Gemini 热池上限',
        anthropicHotPool: 'Anthropic 热池上限',
        refillTriggerGap: '补位触发缺口',
        refillBatchSize: '单次补位批量大小',
        deleteOn401: '账号级上游 401 直接删除账号',
        deleteOn401Hint: '仅针对可确认映射到具体账号的上游认证失效，不包含后台自身 401。',
        runtimeStatus: '运行态状态',
        targetSize: '目标热池',
        currentSize: '当前热池',
        coldCandidates: '冷池候选',
        ...
        triggerRefill: '立即补位',
        triggerRebuild: '立即重建',
        refillTriggered: '已触发热池补位',
        rebuildTriggered: '已触发热池重建',
        actionFailed: '热池操作失败',
        saved: '极致性能模式设置已保存',
        saveFailed: '保存极致性能模式设置失败'
      },
      overloadCooldown: {
        title: '529 过载冷却',
        description: '配置上游返回 529（过载）时的账号调度暂停策略',
        enabled: '启用 529 冷却',
        enabledHint: '收到 529 时自动暂停该账号调度，避免问题账号持续被选中',
        cooldownMinutes: '冷却时长（分钟）',
        cooldownMinutesHint: '建议 1-30 分钟，默认 10 分钟',
        saved: '过载冷却设置已保存',
