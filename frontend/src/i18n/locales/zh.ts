  ...
  admin: {
    ...
    backup: {
      ...
      s3: {
        ...
        authStatus: '鉴权状态',
        authConfigured: 'Access Key 与 Secret 已配置',
        authIncomplete: '凭证未填写完整',
        authNotConfigured: '尚未配置凭证',
      ...
      operations: {
        ...
        restoreFailed: '恢复失败',
        importSuccess: '已从 S3 导入 {imported} 条备份记录（扫描 {scanned} 个，跳过 {skipped} 个）',
        importNoop: 'S3 扫描完成，没有发现新的备份记录（扫描 {scanned} 个，跳过 {skipped} 个）',
      },
      columns: {
        status: '状态',
        fileName: '文件名',
