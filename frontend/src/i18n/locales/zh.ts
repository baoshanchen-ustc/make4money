export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      quotaLimitHint: '配置账号用量配额和客户端亲和限制。',
      quotaLimitToggle: '启用配额限制',
      quotaLimitToggleHint: '开启后，当账号用量达到设定额度时自动暂停调度',
      quotaLimitAmount: '总限额',
      quotaLimitAmountHint: '累计用量上限（美元），不自动重置。',
      quotaDailyLimit: '日限额',
      quotaDailyLimitHint: '每24小时最大可用额度，从首次使用时开始自动重置。',
      quotaWeeklyLimit: '周限额',
      quotaWeeklyLimitHint: '每7天最大可用额度，从首次使用时开始自动重置。',
      quotaTotalLimit: '总限额',
      quotaTotalLimitHint: '累计用量上限（美元），不自动重置。',
      testConnection: '测试连接',
      reAuthorize: '重新授权',
      refreshToken: '刷新令牌',
      noAccountsYet: '暂无账号',
