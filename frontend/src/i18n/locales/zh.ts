  ...
  admin: {
    ...
    accounts: {
      ...
      errorCleanup: {
        ...
        previewing: '复测中...',
        executing: '删除中...',
        title: '复测并清理 Error 账号',
        confirm: '检测到 {total} 个 Error 账号；复测后已恢复 {recovered} 个；仍失败并将删除 {delete} 个。确认继续吗？此操作无法撤销。',
        noErrorAccounts: '当前没有 Error 账号',
        recoveredOnly: '复测完成，已恢复 {count} 个账号，无需删除',
        executeSuccess: '已删除 {count} 个复测后仍失败的账号',
        executePartial: '清理部分完成：删除 {success} 个，失败 {failed} 个，跳过 {skipped} 个',
        previewFailed: '复测 Error 账号失败',
        executeFailed: '删除 Error 账号失败'
      },
      recoverState: '恢复状态',
