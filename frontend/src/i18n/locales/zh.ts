export default {
    ...
    pendingAuth: {
      login: {
        ...
        adoptExistingDescription:
          "请先验证您已有的本站账户所有权，再把这个第三方身份绑定进去。",
        bindCurrentDescription:
          "请重新登录，以继续把这个第三方身份绑定到当前账户。",
      },
      register: {
        title: "继续完成本站账户创建",
        description:
          "请为这个第三方登录创建本站邮箱和密码账户。第三方返回的邮箱不会被当作已验证的本站邮箱绑定。",
      },
    },
    thirdParty: {
      ...
      callback: {
        ...
        pending: {
          login: {
            ...
            summaryDescription:
              "已生成待处理认证会话。请继续创建账户，或验证已有账户后完成绑定。",
            actions: {
              createAccount: "创建账户",
              bindExisting: "绑定已有账户",
            },
          ...
          adoptExisting: {
            title: "确认账户所有权",
            description:
              "第三方身份已完成认证，但仍需通过站内邮箱验证已有账户所有权。",
            summaryTitle: "确认账户所有权",
            summaryDescription:
              "请先完成本站已有账户验证，再把这个第三方身份附加到现有账户。",
            actions: {
              verifyAndBind: "验证并绑定",
            },
          },
  ...
  profile: {
    ...
    bindings: {
      ...
      disconnectConfirm: "确定要解除这个登录方式吗？",
      disconnectSuccess: "登录方式已解除绑定",
      disconnectFailed: "解除绑定失败",
      providers: {
        email: "邮箱",
        linuxdo: "Linux.do",
        wechat: "微信",
    ...
    settings: {
      ...
      payment: {
        ...
        providerUiCapabilityNotice:
          "前台支付能力统一显示为 支付宝 / 微信 / Stripe。下方 provider 仅用于选择由官方支付宝、官方微信、易支付或 Stripe 承载这些能力。",
        ...
        fieldHint_stripe_publishableKey:
          "Stripe Publishable Key，用于前端加载 Payment Element。",
