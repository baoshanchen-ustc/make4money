export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      createAccount: 'Create Account',
      codexBulk: {
        openButton: 'Bulk Add Codex',
        title: 'Bulk Add Codex Accounts',
        intro: 'Built for high-volume Codex imports. The system validates RTs first, then auto-assigns from the proxy pool with a default ratio of 4 accounts per proxy.',
        batchId: 'Batch ID',
        batchIdHint: 'Stored in account names and batch metadata for later search and operations.',
        nameTemplate: 'Name Template',
        nameTemplateHint: 'Supports {batch} and {index}. If {index} is omitted, the system appends it automatically.',
        accountsPerProxy: 'Accounts Per Proxy',
        accountsPerProxyHint: 'Default is 4. Available slots are calculated from current proxy usage.',
        concurrency: 'Concurrency',
        priority: 'Priority',
        rateMultiplier: 'Account Multiplier',
        notes: 'Notes',
        notesPlaceholder: 'Example: 202603 bulk import / Tokyo proxy pool',
        groups: 'Groups',
        proxyPool: 'Proxy Pool',
        proxyPoolRequired: 'Select at least one proxy',
        failedToLoadProxies: 'Failed to load proxy pool',
        selectedProxyCount: 'Selected Proxies',
        eligibleProxyCount: 'Eligible Proxies',
        estimatedCapacity: 'Estimated Capacity',
        allocatableIpsTitle: 'Allocatable IPs',
        allocatableIpsHint: 'Shows only proxies that are currently eligible and still have assignment capacity.',
        selectedCapacity: 'Selected proxies can create about {count} accounts',
        selectEligible: 'Select All Eligible',
        eligible: 'Eligible',
        unavailable: 'Unavailable',
        accountCount: 'Current accounts {count}',
        allocatableCapacity: 'Allocatable {count}',
        noAllocatableIps: 'No allocatable IPs right now',
        qualityGrade: 'Quality {grade} / {score}',
        latencyStatus: 'Latency {status}',
        noProxies: 'No proxies to display',
        refreshTokens: 'Refresh Tokens',
        refreshTokensPlaceholder: 'One RT per line. Paste up to 100 lines or upload a txt/csv file.',
        refreshTokensRequired: 'Enter at least one refresh token',
        uploadFile: 'Upload File',
        failedToReadFile: 'Failed to read file',
        parsedCount: 'Parsed {count} RTs',
        ...
        previewReady: 'Ready',
        previewFailedLabel: 'Failed',
        previewRemainingCapacity: 'Remaining Capacity',
        previewReadyToast: 'Preview ready: {ready} creatable, {failed} failed',
        previewFailedError: 'Preview failed',
        previewRequired: 'Run a fresh preview before importing',
        previewOutdated: 'Form values changed. Run preview again before importing.',
        proxyAllocation: 'Proxy Allocation',
        proxyAllocationLine: '{assigned} assigned this batch, {current} currently, {total} after import',
        itemResults: 'Per-item Results',
        importButton: 'Import',
        importing: 'Importing...',
        importDoneToast: 'Import finished: {created} created, {failed} failed',
