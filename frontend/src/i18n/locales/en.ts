export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      errorCleanup: {
        action: 'Retest & Clean Error',
        previewing: 'Retesting...',
        executing: 'Deleting...',
        title: 'Retest and Clean Error Accounts',
        confirm: 'Detected {total} error account(s); {recovered} recovered after retest; {delete} still failing and will be deleted. Continue? This action cannot be undone.',
        noErrorAccounts: 'There are no error accounts right now',
        recoveredOnly: 'Retest finished. Recovered {count} account(s); nothing needs deletion.',
        executeSuccess: 'Deleted {count} account(s) that still failed after retest',
        executePartial: 'Cleanup partially finished: deleted {success}, failed {failed}, skipped {skipped}',
        previewFailed: 'Failed to retest error accounts',
        executeFailed: 'Failed to delete error accounts'
      },
