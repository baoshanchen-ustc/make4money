export default {
  ...
  auth: {
    ...
    wechat: {
      ...
      scanTip: 'Scan the QR code above with WeChat to sign in',
      scanTipOfficial: 'Scan the QR code above with WeChat, follow the official account and reply with the keyword to get the verification code',
      scanAutoTip: 'Scan the QR code above with WeChat to sign in automatically',
      scanWaiting: 'Waiting for scan...',
      scanConfirmed: 'Scan confirmed, signing in...',
      scanExpired: 'QR code expired',
      scanRefresh: 'Refresh QR code',
      scanError: 'Scan login failed',
    ...
    emailBind: {
      ...
      titleRequired: 'Please Bind Email',
      ...
      descriptionRequired: 'For account security, please bind your email and set a password on first use.',
  ...
  redeem: {
    ...
    wechatRecharge: 'Balance Added (WeChat Pay)',
    wechatRefunded: 'Refunded (WeChat Pay)',
  ...
  admin: {
    ...
    users: {
      ...
      typeWechatRecharge: 'Balance (WeChat Pay)',
    ...
    settings: {
      ...
      wechat: {
        ...
        accountType: 'Account Type',
        accountTypeSubscription: 'Subscription Account',
        accountTypeUnverifiedOfficial: 'Unverified Official Account',
        accountTypeHint: 'Select your WeChat account type. Different types will show different login instructions',
  ...
  recharge: {
    ...
    qrcodeHint: 'Scan with WeChat to pay',
  ...
  subscriptionPlan: {
    ...
    upgradeKeyGuideTitle: 'Upgrade Complete',
    upgradeKeyGuideMessage: 'This order was an upgrade. To avoid request failures, update the group on your active API Keys to the new plan now.',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        ...
        descriptionStandard: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the Code80 AI service platform.</p><p style="margin-bottom: 12px;"><b>Three Steps to Get Started:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>Create API Key</li><li>Learn about subscriptions & balance</li><li>Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Follow the guide, you\'ll be up and running in no time →</p></div>',
        nextBtn: 'Start',
        prevBtn: 'Skip'
      },
      keyManage: {
      ...
      subscriptions: {
        ...
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Your key is ready. Now let\'s learn how to get usage credits.</p><div style="padding: 8px 12px; background: #eff6ff; border-left: 3px solid #3b82f6; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>About Balance:</b><ul style="margin: 8px 0 0 16px;"><li>API calls consume balance</li><li>Requests are rejected when balance is insufficient</li><li>Check your balance and usage on the "My Subscriptions" page</li></ul></div><p style="padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>Tip:</b> Learn how to get balance before using the service</p></div>'
      },
      complete: {
        title: 'Guide Complete',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Your key is ready. You\'ll need balance to start using the service.</p><div style="padding: 8px 12px; background: #eff6ff; border-left: 3px solid #3b82f6; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>Ways to Get Balance:</b><ul style="margin: 8px 0 0 16px;">__METHODS__</ul></div><p style="padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>Ready?</b><br/>After getting balance, configure the key in any OpenAI-compatible client to start using!</p></div>',
        methodPurchase: 'Purchase a subscription plan',
        methodRecharge: 'Recharge online',
        methodRedeem: 'Redeem with a code'
      }
    }
  },
