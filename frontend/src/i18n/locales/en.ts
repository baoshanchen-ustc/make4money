export default {
  ...
  admin: {
    ...
    settings: {
      ...
      useKeyTemplate: {
        title: 'Custom Use Key Templates',
        description: 'Customize the configuration templates shown in the "Use Key" modal for each client. Leave empty to use the default template.',
        client: 'Client',
        system: 'System / Shell',
        file: 'File',
        editorLabel: 'Template Content',
        placeholderHint: 'Supports variables: ${baseUrl} (API endpoint), ${apiKey} (API key). Leave empty to use the default template shown above.',
        save: 'Stage Template',
        resetToDefault: 'Fill Default',
        saved: 'Template staged',
        savedList: 'Customized Templates',
        saveHint: 'After making changes, you still need to click the "Save Settings" button at the bottom of the page to apply them.',
      },
      payment: {
