export default {
  ...
  admin: {
    ...
    subscriptions: {
      ...
      total: 'Total',
      expiringQuotaHint: '${amount} expires in {time}',
      ...
      groupHint: 'Only subscription and total quota groups are shown',
