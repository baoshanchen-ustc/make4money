export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      vertexServiceAccountJsonHint:
        'Service Account key JSON downloaded from GCP Console (paste the full content; stored encrypted).',
      vertexServiceAccountJsonRequired: 'Service Account JSON is required',
      vertexServiceAccountJsonInvalid: 'Service Account JSON is malformed',
      vertexProjectId: 'GCP Project ID',
      vertexProjectIdHint: 'GCP project ID (usually matches project_id inside the SA JSON).',
      vertexProjectIdRequired: 'GCP Project ID is required',
      vertexRegion: 'Region',
      vertexRegionHint:
        'Vertex AI region — model availability varies (see GCP docs). Use "global" for multi-region routing.',
