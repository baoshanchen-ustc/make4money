  ...
  admin: {
    ...
    backup: {
      ...
      s3: {
        ...
        descriptionSuffix: ')',
        currentTarget: 'Current Backup Target',
        ...
        authConfigured: 'Access key and secret are configured',
        authIncomplete: 'Credentials are incomplete',
        authNotConfigured: 'Credentials are not configured yet',
      ...
      operations: {
        ...
        importSuccess: 'Imported {imported} backup records from S3 ({scanned} scanned, {skipped} skipped)',
        importNoop: 'S3 scan finished: no new backup records imported ({scanned} scanned, {skipped} skipped)',
      },
      columns: {
        status: 'Status',
        fileName: 'File Name',
