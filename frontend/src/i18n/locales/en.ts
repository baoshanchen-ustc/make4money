  ...
  admin: {
    ...
    settings: {
      ...
      extremePerformance: {
        ...
        description: 'Keep original features while disabling automatic admin usage requests and preparing the system for hot-pool scheduling.',
        enabled: 'Enable extreme performance mode',
        enabledHint: 'When enabled, admin pages and scheduling will gradually switch to lightweight / hot-pool behavior.',
        disableAutoUsageFetch: 'Disable automatic usage refresh',
        disableAutoUsageFetchHint: 'The accounts list will stop auto-requesting /usage and rely on manual actions.',
        disableAutoTodayStatsFetch: 'Disable automatic today stats refresh',
        disableAutoTodayStatsFetchHint: 'The accounts list will stop auto-requesting /today-stats/batch.',
        allowManualUsageFetch: 'Allow manual usage inspection',
        allowManualUsageFetchHint: 'Keep manual single-account usage fetch available so original functionality is preserved.',
        openaiHotPool: 'OpenAI hot pool limit',
        geminiHotPool: 'Gemini hot pool limit',
        anthropicHotPool: 'Anthropic hot pool limit',
        refillTriggerGap: 'Refill trigger gap',
        refillBatchSize: 'Refill batch size',
        deleteOn401: 'Delete account on account-level upstream 401',
        deleteOn401Hint: 'Only applies to upstream authentication failures that can be mapped to a concrete account.',
        runtimeStatus: 'Runtime status',
        targetSize: 'Target hot pool',
        currentSize: 'Current hot pool',
        coldCandidates: 'Cold candidates',
        version: 'Version',
        triggerRefill: 'Trigger refill',
        triggerRebuild: 'Trigger rebuild',
        refillTriggered: 'Hot pool refill triggered',
        rebuildTriggered: 'Hot pool rebuild triggered',
        actionFailed: 'Hot pool action failed',
        saved: 'Extreme performance settings saved',
        saveFailed: 'Failed to save extreme performance settings'
      },
      overloadCooldown: {
        title: '529 Overload Cooldown',
        description: 'Configure account scheduling pause strategy when upstream returns 529 (overloaded)',
        enabled: 'Enable 529 cooldown',
        enabledHint: 'Automatically pause scheduling for this account when 529 is received',
        cooldownMinutes: 'Cooldown Duration (minutes)',
        cooldownMinutesHint: 'Recommended 1-30 minutes, default 10 minutes',
