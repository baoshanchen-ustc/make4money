export default {
  ...
  connectivityTest: {
    ...
    description: 'Test streaming stability through your current network/proxy. Sends a long-generation request to detect 60-second proxy timeouts and connection drops.',
    ...
    endpoint: 'Endpoint',
    prompt: 'Test Prompt',
    promptHint: '(designed to produce a long response)',
    ...
    throughput: 'Speed',
    timeoutThreshold: 'Timeout Threshold (s)',
    timeoutThresholdHint: 'Proxy timeout threshold in seconds, default 60',
    streamDuration: 'Stream Duration (s)',
    streamDurationHint: 'Ask the model to stream for this many seconds, default 70',
    timeline: 'Timeline',
    events: 'Event Log',
    noEvents: 'Waiting to start...',
    ...
    diagnosis: 'Diagnosis',
    approachingTimeout: '⚠ Approaching {sec}s — watching for proxy timeout...',
    eventConnecting: 'Connecting to {endpoint}',
    eventModel: 'Model: {model}',
    eventStreamMode: 'Mode: stream=true (Anthropic SSE)',
    eventHttpError: 'HTTP {status}: {body}',
    eventConnected: 'Connected — HTTP {status}',
    eventFirstChunk: 'First chunk received at {ms}ms',
    eventMessageStop: 'message_stop event received',
    eventActualModel: 'Actual model: {model}',
    eventError: 'Upstream error: {msg}',
    eventStreamEnd: 'Stream ended (reader done)',
    eventUncleanEnd: 'Stream ended without [DONE] at {sec}s',
    eventAborted: 'Test stopped by user',
    eventFetchError: 'Fetch error: {msg}',
    eventSuccess: 'Complete in {sec}s — {tokens} tokens',
    resultSuccess: 'Stream completed cleanly in {sec}s ({tokens} tokens, {chunks} chunks)',
    resultHttpError: 'HTTP error {status} — check API key and endpoint',
    resultUnclean: 'Stream ended without clean termination at {sec}s',
    resultAborted: 'Test stopped by user after {sec}s',
    resultError: 'Error: {msg}',
    diagnosisSlowButOk: 'Completed successfully in {sec}s. Response time is slow but stable — no proxy cutoff detected.',
    diagnosisGood: 'Excellent! Stream completed quickly and cleanly. Network/proxy is healthy.',
    diagnosisUnclean: 'Stream ended without [DONE] or message_stop. May indicate a mid-transfer connection drop.',
    diagnosisTimeout: 'Connection dropped at ~{sec}s. This is a classic proxy/load-balancer timeout. Your proxy likely has a {sec}s idle or response timeout. Try switching to a proxy without a stream timeout, or use a direct connection.',
    diagnosis60s: 'Connection dropped at ~60 seconds. This is a classic proxy/load-balancer timeout. Your proxy likely has a 60s idle or response timeout. Try switching to a proxy without a stream timeout, or use a direct connection.',
    diagnosisQuickFail: 'Connection failed very quickly. Check your API key, endpoint URL, and whether the service is reachable.',
    diagnosisGeneral: 'Connection dropped after {sec}s. Could be a proxy timeout, network instability, or upstream rate limiting.'
  },
  ...
  admin: {
    ...
    accounts: {
      ...
      copilot: {
        ...
        planTypeHint: 'Select your GitHub Copilot subscription tier. Individual Free/Pro/Pro+ all use the same API endpoint; Business and Enterprise use separate endpoints.',
        planTypeIndividual: 'Individual',
        planTypeIndividualFree: 'Free',
        planTypeIndividualPro: 'Pro',
        planTypeIndividualProPlus: 'Pro+',
    ...
    modelPricings: {
      title: 'Model Pricing',
      description: 'Manage fallback pricing for models (priority: LiteLLM dynamic → this page → built-in defaults)',
      addEntry: 'Add Pricing',
      editEntry: 'Edit Pricing',
      deleteEntry: 'Delete',
      modelKey: 'Model Key',
      displayName: 'Display Name',
      inputPrice: 'Input Price',
      outputPrice: 'Output Price',
      inputPricePriority: 'Input Price (Priority)',
      outputPricePriority: 'Output Price (Priority)',
      cacheReadPrice: 'Cache Read Price',
      cacheReadPricePriority: 'Cache Read (Priority)',
      priorityTipTitle: 'What is Priority pricing?',
      priorityTipBody: 'OpenAI offers two service tiers: Default and Priority. When a request includes service_tier: "auto", OpenAI may route it to the Priority tier and charge the Priority price (roughly 2× standard). Leave these fields at 0 and the system will estimate Priority cost as 2× the standard price. Only relevant for OpenAI models that support dual tiers — leave blank for other providers.',
      priorityPlaceholder: 'Leave blank → 2× standard',
      cacheCreationPrice: 'Cache Creation Price',
      perMillion: '/ 1M Tokens',
      enabled: 'Enabled',
      note: 'Note',
      source: 'Price Source',
      sourceLitellm: 'LiteLLM Dynamic',
      sourceDb: 'DB Config',
      ...
      noEntries: 'No pricing entries',
      calculationLogic: 'Billing Logic',
      usdPerMillion: 'USD / 1M Tokens',
      // Three-tier compare
    ...
    ops: {
      ...
      requestInspect: {
        ...
        anomalyFilter: 'Anomaly type',
        anomalyPlaceholder: 'All',
        platform: 'Platform',
        searchQ: 'Search',
