export default {
  ...
  home: {
    ...
    tags: {
      subscriptionToApi: "The World's Most NB AI API Proxy",
  ...
  setup: {
    title: 'nbAPI Setup',
    description: 'Configure your nbAPI instance',
    database: {
  ...
  admin: {
    ...
    accounts: {
      ...
      types: {
        ...
        soraApiKeyHint: 'Connect to another nbAPI or compatible API',
      ...
      soraUpstreamBaseUrlHint: 'Upstream Sora service URL (another nbAPI instance or compatible API)',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for nbAPI end-user login',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'nbAPI',
        siteNameHint: 'Displayed in emails and page titles',
        siteSubtitle: 'Site Subtitle',
        siteSubtitlePlaceholder: 'The World's Most NB AI API Proxy Conversion Platform',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to nbAPI',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the nbAPI AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
