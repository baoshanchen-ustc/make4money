export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      cpaImport: 'Import from CPA',
      cpaImportTitle: 'Import from CPA',
      cpaImportModeRemote: 'Connect CPA',
      cpaImportModeFile: 'Upload File',
      cpaImportHint: 'Upload the auth JSON file downloaded from CLIProxyAPI and import it as a sub2api account.',
      cpaImportRemoteHint: 'Connect to a CLIProxyAPI management endpoint. The backend will only preview and import accounts whose status is active.',
      cpaImportWarning: 'Currently supports Claude / Codex / Gemini / Antigravity auth files. This local file mode cannot verify remote status, so only use it for auth files you already know are valid. Existing linked accounts will be updated; new accounts will be created with the defaults below.',
      cpaImportRemoteWarning: 'Only active CPA auth files are imported. Non-normal statuses and unsupported providers are filtered out by the backend before import.',
      cpaRemoteBaseUrl: 'CPA Base URL',
      cpaRemoteBaseUrlPlaceholder: 'e.g. https://example.com',
      cpaRemoteManagementKey: 'Management Key',
      cpaRemoteMissingFields: 'Please fill CPA base URL and Management Key',
      cpaRemotePreviewSummaryTitle: 'Preview Summary',
      cpaRemotePreviewSummary: 'Found {total} auth files, importable {importable}, filtered non-normal {skipped_non_normal}, unsupported {skipped_unsupported}.',
      cpaRemoteStatusFilterNote: 'Only status=active files are shown below.',
      cpaRemoteExistingAccounts: 'Existing accounts (will be updated)',
      cpaRemoteNewAccounts: 'New accounts (select to import)',
      cpaRemoteNoImportableAccounts: 'No active CPA accounts are currently importable.',
      cpaImportFile: 'CPA auth file',
      cpaImportSelectFile: 'Please select a CPA auth file',
      cpaImportPreview: 'Preview',
      cpaImportPreviewing: 'Previewing...',
      cpaImportPreviewFailed: 'Failed to preview CPA file',
      cpaImportButton: 'Start Import',
      cpaImporting: 'Importing...',
      cpaImportFailed: 'CPA import failed',
      cpaImportResult: 'Import Result',
      cpaImportResultSummary: 'Created {created}, updated {updated}, failed {failed}',
      cpaImportErrors: 'Error Details',
      cpaImportSuccess: 'CPA import completed: created {created}, updated {updated}',
      cpaImportCompletedWithErrors: 'CPA import completed with errors: failed {failed}',
      cpaImportExistingTitle: 'Existing imported account found',
      cpaImportExistingDesc: 'The existing account "{name}" will have its credentials and source metadata updated. Current proxy, groups, and concurrency will be preserved.',
      cpaImportConcurrency: 'Default concurrency',
      cpaUseDefaultGroupBind: 'Auto-bind new accounts to platform default groups (recommended)',
      cpaManualGroupsHint: 'When default binding is disabled, you can manually choose groups for newly created accounts.',
      cpaManualGroupsMultiPlatformHint: 'Manual group selection is only available when the selected new CPA accounts are all on the same platform. Keep default group binding enabled for mixed-platform imports.',
