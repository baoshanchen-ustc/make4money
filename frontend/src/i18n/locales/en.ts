export default {
  ...
  admin: {
    ...
    proxies: {
      ...
      subscriptionImportTitle: 'Import SS Proxies From Subscription',
      subscriptionImportHint: 'Enter a public subscription URL. The system will parse supported SS nodes and import them through the existing batch create flow.',
      subscriptionImportNote: 'Only SS nodes are supported right now. SS nodes with plugins and other protocols are skipped automatically.',
      subscriptionImportUrl: 'Subscription URL',
      subscriptionImportUrlPlaceholder: 'https://example.com/subscription.txt',
      subscriptionImportUrlRequired: 'Enter a subscription URL',
      subscriptionImportParse: 'Parse Subscription',
      subscriptionImportParsing: 'Parsing...',
      subscriptionImportParsed: 'Parsed {count} importable SS proxies',
      subscriptionImportSelected: 'Selected {count} / {total} nodes',
      subscriptionImportSelectHint: 'Choose which nodes to import. All parsed nodes are selected by default.',
      subscriptionImportSearchPlaceholder: 'Search by node name',
      subscriptionImportSelectAll: 'Select All',
      subscriptionImportClearSelection: 'Clear Selection',
      subscriptionImportNoMatch: 'No matching nodes',
      subscriptionImportPreviewMore: '{count} more nodes not shown',
      subscriptionImportButton: 'Import Selected {count} Proxies',
      subscriptionImportFailed: 'Failed to parse subscription',
      subscriptionImportEmpty: 'Parse importable proxies before importing',
      subscriptionImportSelectionEmpty: 'Select at least one proxy to import',
      dataExport: 'Export',
      ...
      ssMethodRequired: 'Shadowsocks proxies require a cipher method',
      ssPasswordRequired: 'Shadowsocks proxies require a password',
      status: 'Status',
      ...
      batchInputHint:
        "Supports http, https, socks5, socks5h, and ss protocols. Format: protocol://[user:pass{'@'}]host:port",
      ...
      qualityRegion: 'Exit Subdivision',
      qualityCity: 'Exit City',
