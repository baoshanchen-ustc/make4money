export default {
  ...
  auth: {
    ...
    wechat: {
      ...
      disabledNeedWechatEnv:
        "This WeChat login is available only inside the WeChat browser.",
      disabledNeedExternalBrowser:
        "This WeChat login is available only in a standard browser outside WeChat.",
    },
    pendingAuth: {
      login: {
        title: "Continue account verification",
        defaultDescription:
          "Sign in with your existing local account to bind this third-party identity.",
        adoptExistingDescription:
          "Verify your local account to confirm ownership before attaching this third-party identity.",
        bindCurrentDescription:
          "Sign in again to continue binding this third-party identity to your current account.",
      },
      register: {
        title: "Complete local account setup",
        description:
          "Create a local email/password account for this third-party login. Provider emails are not treated as verified local email bindings.",
      },
    },
    thirdParty: {
      ...
      callback: {
        ...
        pending: {
          login: {
            ...
            description:
              "Choose whether to create a new account or verify ownership of an existing one.",
            summaryTitle: "Create a new account or bind an existing account",
            summaryDescription:
              "A pending session was created. Continue with account creation or existing-account verification.",
            actions: {
              createAccount: "Create account",
          ...
          bindCurrent: {
            ...
            description:
              "The provider identity is authenticated. Finish the bind flow against the currently signed-in account.",
            summaryTitle: "Bind this identity to your current account",
            summaryDescription:
              "This callback intentionally stopped before token issuance so the bind can complete against the active session.",
            actions: {
          ...
          adoptExisting: {
            ...
            description:
              "The provider identity is authenticated, but account ownership must still be verified through your site email.",
            summaryTitle: "Confirm account ownership",
            summaryDescription:
              "Continue with local account verification before this identity can be attached to an existing account.",
            actions: {
        ...
        success: {
          ...
          description:
            "The callback returned tokens for an existing account or a completed bind flow.",
          summaryTitle: "Authentication response received",
          adoptionRequired:
            "Before finishing, review whether to adopt the provider nickname or avatar.",
  ...
  profile: {
    ...
    bindings: {
      title: "Login Methods",
      description:
        "Connect and review the sign-in methods available on your account.",
      status: {
        bound: "Connected",
      ...
      disconnectConfirm: "Disconnect this sign-in method?",
      disconnectSuccess: "Sign-in method disconnected",
      disconnectFailed: "Failed to disconnect sign-in method",
      providers: {
        email: "Email",
        linuxdo: "Linux.do",
        wechat: "WeChat",
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        providerUiCapabilityNotice:
          "Frontend payment capabilities are normalized to Alipay / WeChat Pay / Stripe. The providers below only decide whether those capabilities are carried by Official Alipay, Official WeChat Pay, EasyPay, or Stripe.",
        ...
        fieldHint_easypay_apiBase:
          "EasyPay gateway base URL, for example https://pay.example.com.",
        fieldHint_easypay_cidAlipay:
          "Optional. Fill this when Alipay should be mapped to a dedicated EasyPay channel.",
        fieldHint_easypay_cidWxpay:
          "Optional. Fill this when WeChat Pay should be mapped to a dedicated EasyPay channel.",
        fieldHint_alipay_appId:
          "Alipay application AppID for the frontend “Alipay” capability without exposing the implementation detail.",
        fieldHint_alipay_privateKey:
          "Alipay application private key used to sign requests.",
        fieldHint_alipay_publicKey:
          "Alipay platform public key used to verify callbacks.",
        fieldHint_wxpay_appId:
          "Merchant-side AppID for WeChat Pay. It is payment config and should not be overwritten from WeChat login MP config.",
        fieldHint_wxpay_mchId:
          "WeChat Pay merchant ID used only for the payment merchant identity.",
        fieldHint_wxpay_privateKey:
          "Merchant API certificate private key content.",
        fieldHint_wxpay_apiV3Key: "32-byte API v3 key.",
        fieldHint_wxpay_publicKey:
          "WeChat Pay platform public key content for callback verification.",
        fieldHint_wxpay_publicKeyId:
          "Platform public key ID, optional depending on your current integration.",
        fieldHint_wxpay_certSerial:
          "Merchant API certificate serial number, optional.",
        fieldHint_wxpay_mpAppId:
          "MP web auth AppID. Use it only for in-WeChat web auth / JSAPI related capabilities, and it can be copied from WeChat login MP config.",
        fieldHint_wxpay_mpAppSecret:
          "MP web auth AppSecret. It only supplements MP login / JSAPI related capability and does not replace merchant ID, certificates, or API keys.",
        fieldHint_stripe_secretKey:
          "Stripe Secret Key used by the server to create payment intents.",
        fieldHint_stripe_publishableKey:
          "Stripe Publishable Key used by the frontend to load Payment Element.",
        fieldHint_stripe_webhookSecret:
        ...
        wxpayMpSyncHint:
          "One-click sync copies the WeChat login MP AppID / AppSecret to supplement web authorization only, and never reads or overwrites merchant ID, API v3 key, certificates, or platform keys.",
        wxpayMpSyncPlaceholderToast:
          "Sync reads only the WeChat login MP AppID / AppSecret and never changes merchant ID, API v3 key, certificates, or platform keys.",
        stripeWebhookHint:
