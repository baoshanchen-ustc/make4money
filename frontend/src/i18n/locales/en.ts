export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      quotaLimitHint: 'Configure account usage quota and client affinity limits.',
      ...
      quotaLimitAmountHint: 'Cumulative spending limit (USD). Never resets automatically.',
      quotaDailyLimit: 'Daily Limit',
      quotaDailyLimitHint: 'Maximum spending per 24-hour period. Resets automatically from first usage.',
      quotaWeeklyLimit: 'Weekly Limit',
      quotaWeeklyLimitHint: 'Maximum spending per 7-day period. Resets automatically from first usage.',
      quotaTotalLimit: 'Total Limit',
      quotaTotalLimitHint: 'Cumulative spending limit (USD). Never resets automatically.',
      testConnection: 'Test Connection',
