...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'bigmodel' | 'minimax' | 'kimi'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'bigmodel' | 'minimax' | 'kimi'
