<template>
  <AppLayout>
    ...
    <ScheduledTestsPanel v-if="showSchedulePanel && scheduleAcc" :show="showSchedulePanel" :account-id="scheduleAcc.id" :model-options="scheduleModelOptions" @close="closeSchedulePanel" />
