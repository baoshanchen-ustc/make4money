...
func TestOpenAIGatewayServiceRecordUsage_ZeroUsageSkipsUsageLogButRunsBilling(t *testing.T) {
	...
	// Zero usage skips DB usage_log write but billing + service_quota.Record still execute
