...
func ProvideRouter(
	...
	return SetupRouter(r, handlers, jwtAuth, adminAuth, scopedAdminAuth, apiKeyAuth, apiKeyService, subscriptionService, opsService, settingService, cfg, redisClient)
}
