...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	soraGatewayHandler := handler.NewSoraGatewayHandler(gatewayService, soraGatewayService, concurrencyService, billingCacheService, usageRecordWorkerPool, apiKeyService, configConfig)
	copilotGatewayHandler := handler.NewCopilotGatewayHandler(gatewayService, copilotGatewayService, concurrencyService, billingCacheService, apiKeyService, configConfig)
