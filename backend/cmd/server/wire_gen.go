...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	hotPoolCache := repository.NewHotPoolCache(redisClient)
	hotPoolService := service.NewHotPoolService(hotPoolCache, accountRepository)
	...
	accountTestService.SetAccountFailurePolicy(accountFailurePolicyService)
	...
	settingHandler := admin.NewSettingHandler(settingService, emailService, turnstileService, opsService, soraS3Storage, hotPoolService)
