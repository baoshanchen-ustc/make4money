...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.BalanceLog, c.Group, c.PaymentCallback, c.PromoCode, c.PromoCodeUsage,
		c.Proxy, c.RechargeOrder, c.RedeemCode, c.Setting, c.SubscriptionOrder,
...
// UpdateOne returns an update builder for the given entity.
func (c *BalanceLogClient) UpdateOne(_m *BalanceLog) *BalanceLogUpdateOne {
	mutation := newBalanceLogMutation(c.config, OpUpdateOne, withBalanceLog(_m))
	return &BalanceLogUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *BalanceLogClient) UpdateOneID(id int64) *BalanceLogUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity.
func (c *BalanceLogClient) DeleteOne(_m *BalanceLog) *BalanceLogDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *BalanceLogClient) DeleteOneID(id int64) *BalanceLogDeleteOne {
...
func (c *BalanceLogClient) Get(ctx context.Context, id int64) (*BalanceLog, error) {
	return c.Query().Where(balancelog.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *BalanceLogClient) GetX(ctx context.Context, id int64) *BalanceLog {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *BalanceLogClient) QueryUser(_m *BalanceLog) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QuerySubscriptionOrders queries the subscription_orders edge of a Group.
func (c *GroupClient) QuerySubscriptionOrders(_m *Group) *SubscriptionOrderQuery {
	query := (&SubscriptionOrderClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(group.Table, group.FieldID, id),
			sqlgraph.To(subscriptionorder.Table, subscriptionorder.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, group.SubscriptionOrdersTable, group.SubscriptionOrdersColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// UpdateOne returns an update builder for the given entity.
func (c *PaymentCallbackClient) UpdateOne(_m *PaymentCallback) *PaymentCallbackUpdateOne {
	mutation := newPaymentCallbackMutation(c.config, OpUpdateOne, withPaymentCallback(_m))
	return &PaymentCallbackUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *PaymentCallbackClient) UpdateOneID(id int64) *PaymentCallbackUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity.
func (c *PaymentCallbackClient) DeleteOne(_m *PaymentCallback) *PaymentCallbackDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *PaymentCallbackClient) DeleteOneID(id int64) *PaymentCallbackDeleteOne {
...
func (c *PaymentCallbackClient) Get(ctx context.Context, id int64) (*PaymentCallback, error) {
	return c.Query().Where(paymentcallback.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *PaymentCallbackClient) GetX(ctx context.Context, id int64) *PaymentCallback {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *PaymentCallbackClient) Hooks() []Hook {
	return c.hooks.PaymentCallback
}

// Interceptors returns the client interceptors.
func (c *PaymentCallbackClient) Interceptors() []Interceptor {
	return c.inters.PaymentCallback
}
...
// UpdateOne returns an update builder for the given entity.
func (c *SubscriptionOrderClient) UpdateOne(_m *SubscriptionOrder) *SubscriptionOrderUpdateOne {
	mutation := newSubscriptionOrderMutation(c.config, OpUpdateOne, withSubscriptionOrder(_m))
	return &SubscriptionOrderUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *SubscriptionOrderClient) UpdateOneID(id int64) *SubscriptionOrderUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity.
func (c *SubscriptionOrderClient) DeleteOne(_m *SubscriptionOrder) *SubscriptionOrderDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *SubscriptionOrderClient) DeleteOneID(id int64) *SubscriptionOrderDeleteOne {
...
func (c *SubscriptionOrderClient) Get(ctx context.Context, id int64) (*SubscriptionOrder, error) {
	return c.Query().Where(subscriptionorder.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *SubscriptionOrderClient) GetX(ctx context.Context, id int64) *SubscriptionOrder {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// QueryUser queries the user edge of a SubscriptionOrder.
func (c *SubscriptionOrderClient) QueryUser(_m *SubscriptionOrder) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(subscriptionorder.Table, subscriptionorder.FieldID, id),
			sqlgraph.To(user.Table, user.FieldID),
...
// QueryGroup queries the group edge of a SubscriptionOrder.
func (c *SubscriptionOrderClient) QueryGroup(_m *SubscriptionOrder) *GroupQuery {
	query := (&GroupClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *SubscriptionOrderClient) mutate(ctx context.Context, m *SubscriptionOrderMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown SubscriptionOrder mutation op: %q", m.Op())
	}
}
...
// QuerySubscriptionOrders queries the subscription_orders edge of a User.
func (c *UserClient) QuerySubscriptionOrders(_m *User) *SubscriptionOrderQuery {
	query := (&SubscriptionOrderClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
type (
	hooks struct {
		...
		Group, PaymentCallback, PromoCode, PromoCodeUsage, Proxy, RechargeOrder,
		RedeemCode, Setting, SubscriptionOrder, UsageCleanupTask, UsageLog, User,
