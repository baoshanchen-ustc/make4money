...
func init() {
	...
	// userDescMaxSessions is the schema descriptor for max_sessions field.
	userDescMaxSessions := userFields[5].Descriptor()
	// user.DefaultMaxSessions holds the default value on creation for the max_sessions field.
	user.DefaultMaxSessions = userDescMaxSessions.Default.(int)
