...
var (
	...
	RechargeOrdersColumns = []*schema.Column{
		...
		{Name: "credited_amount", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "exchange_rate_used", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "user_id", Type: field.TypeInt64},
	}
	...
	RechargeOrdersTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{RechargeOrdersColumns[7]},
			},
			{
				Name:    "rechargeorder_expire_at",
				Unique:  false,
				Columns: []*schema.Column{RechargeOrdersColumns[11]},
			},
			{
				Name:    "rechargeorder_user_id_status",
				Unique:  false,
				Columns: []*schema.Column{RechargeOrdersColumns[22], RechargeOrdersColumns[7]},
			},
		},
	}
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "has_password", Type: field.TypeBool, Default: true},
		{Name: "totp_secret_encrypted", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "totp_enabled", Type: field.TypeBool, Default: false},
		{Name: "totp_enabled_at", Type: field.TypeTime, Nullable: true},
		{Name: "usage_report_enabled", Type: field.TypeBool, Default: true},
