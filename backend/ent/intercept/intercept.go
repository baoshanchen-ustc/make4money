...
// The CopilotBudgetAlertFunc type is an adapter to allow the use of ordinary function as a Querier.
type CopilotBudgetAlertFunc func(context.Context, *ent.CopilotBudgetAlertQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f CopilotBudgetAlertFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.CopilotBudgetAlertQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.CopilotBudgetAlertQuery", q)
}

// The TraverseCopilotBudgetAlert type is an adapter to allow the use of ordinary function as Traverser.
type TraverseCopilotBudgetAlert func(context.Context, *ent.CopilotBudgetAlertQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseCopilotBudgetAlert) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseCopilotBudgetAlert) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.CopilotBudgetAlertQuery); ok {
		return f(ctx, q)
	}
...
type CopilotQuotaSnapshotFunc func(context.Context, *ent.CopilotQuotaSnapshotQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f CopilotQuotaSnapshotFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.CopilotQuotaSnapshotQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.CopilotQuotaSnapshotQuery", q)
}

// The TraverseCopilotQuotaSnapshot type is an adapter to allow the use of ordinary function as Traverser.
type TraverseCopilotQuotaSnapshot func(context.Context, *ent.CopilotQuotaSnapshotQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseCopilotQuotaSnapshot) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseCopilotQuotaSnapshot) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.CopilotQuotaSnapshotQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.CopilotQuotaSnapshotQuery", q)
}
