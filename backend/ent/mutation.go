...
// OldMaxSessions returns the old "max_sessions" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldMaxSessions(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) AddMaxSessions(i int) {
...
func (m *UserMutation) AddedMaxSessions() (r int, exists bool) {
	v := m.addmax_sessions
	if v == nil {
		return
	}
...
func (m *UserMutation) ResetMaxSessions() {
	m.max_sessions = nil
	m.addmax_sessions = nil
}
...
func (m *UserMutation) Fields() []string {
	...
	if m.max_sessions != nil {
		fields = append(fields, user.FieldMaxSessions)
	}
	if m.status != nil {
