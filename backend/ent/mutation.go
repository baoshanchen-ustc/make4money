...
const (
	...
	TypeSetting                 = "Setting"
	TypeSubscriptionOrder       = "SubscriptionOrder"
...
// BalanceLotMutation represents an operation that mutates the BalanceLot nodes in the graph.
type BalanceLotMutation struct {
	config
	op                  Op
	typ                 string
	id                  *int64
	...
	oldValue            func(context.Context) (*BalanceLot, error)
	predicates          []predicate.BalanceLot
}

var _ ent.Mutation = (*BalanceLotMutation)(nil)

// balancelotOption allows management of the mutation configuration using functional options.
type balancelotOption func(*BalanceLotMutation)

// newBalanceLotMutation creates new mutation for the BalanceLot entity.
func newBalanceLotMutation(c config, op Op, opts ...balancelotOption) *BalanceLotMutation {
	m := &BalanceLotMutation{
		config:        c,
		op:            op,
		typ:           TypeBalanceLot,
		clearedFields: make(map[string]struct{}),
...
// withBalanceLotID sets the ID field of the mutation.
func withBalanceLotID(id int64) balancelotOption {
	return func(m *BalanceLotMutation) {
		var (
			err   error
			once  sync.Once
			value *BalanceLot
		)
		m.oldValue = func(ctx context.Context) (*BalanceLot, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().BalanceLot.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withBalanceLot sets the old BalanceLot of the mutation.
func withBalanceLot(node *BalanceLot) balancelotOption {
	return func(m *BalanceLotMutation) {
		m.oldValue = func(context.Context) (*BalanceLot, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m BalanceLotMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m BalanceLotMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *BalanceLotMutation) ID() (id int64, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *BalanceLotMutation) IDs(ctx context.Context) ([]int64, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().BalanceLot.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreatedAt sets the "created_at" field.
func (m *BalanceLotMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *BalanceLotMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the BalanceLot entity.
// If the BalanceLot object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BalanceLotMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *BalanceLotMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *BalanceLotMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *BalanceLotMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the BalanceLot entity.
// If the BalanceLot object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BalanceLotMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *BalanceLotMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// SetUserID sets the "user_id" field.
func (m *BalanceLotMutation) SetUserID(i int64) {
	m.user = &i
}

// UserID returns the value of the "user_id" field in the mutation.
func (m *BalanceLotMutation) UserID() (r int64, exists bool) {
	v := m.user
	if v == nil {
		return
	}
...
// OldUserID returns the old "user_id" field's value of the BalanceLot entity.
// If the BalanceLot object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BalanceLotMutation) OldUserID(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUserID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUserID resets all changes to the "user_id" field.
func (m *BalanceLotMutation) ResetUserID() {
	m.user = nil
}

// SetSourceType sets the "source_type" field.
func (m *BalanceLotMutation) SetSourceType(s string) {
	m.source_type = &s
}

// SourceType returns the value of the "source_type" field in the mutation.
func (m *BalanceLotMutation) SourceType() (r string, exists bool) {
	v := m.source_type
	if v == nil {
		return
	}
...
// OldSourceType returns the old "source_type" field's value of the BalanceLot entity.
// If the BalanceLot object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BalanceLotMutation) OldSourceType(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *BalanceLotMutation) ResetSourceType() {
	m.source_type = nil
}

// SetSourceRef sets the "source_ref" field.
func (m *BalanceLotMutation) SetSourceRef(s string) {
	m.source_ref = &s
}

// SourceRef returns the value of the "source_ref" field in the mutation.
func (m *BalanceLotMutation) SourceRef() (r string, exists bool) {
	v := m.source_ref
	if v == nil {
		return
	}
...
// OldSourceRef returns the old "source_ref" field's value of the BalanceLot entity.
// If the BalanceLot object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BalanceLotMutation) OldSourceRef(ctx context.Context) (v *string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *BalanceLotMutation) ClearSourceRef() {
	m.source_ref = nil
	m.clearedFields[balancelot.FieldSourceRef] = struct{}{}
}

// SourceRefCleared returns if the "source_ref" field was cleared in this mutation.
func (m *BalanceLotMutation) SourceRefCleared() bool {
	_, ok := m.clearedFields[balancelot.FieldSourceRef]
	return ok
}

// ResetSourceRef resets all changes to the "source_ref" field.
func (m *BalanceLotMutation) ResetSourceRef() {
	m.source_ref = nil
	delete(m.clearedFields, balancelot.FieldSourceRef)
}

// SetOriginalAmount sets the "original_amount" field.
func (m *BalanceLotMutation) SetOriginalAmount(f float64) {
	m.original_amount = &f
	m.addoriginal_amount = nil
}

// OriginalAmount returns the value of the "original_amount" field in the mutation.
func (m *BalanceLotMutation) OriginalAmount() (r float64, exists bool) {
	v := m.original_amount
	if v == nil {
		return
	}
...
// OldOriginalAmount returns the old "original_amount" field's value of the BalanceLot entity.
// If the BalanceLot object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BalanceLotMutation) OldOriginalAmount(ctx context.Context) (v float64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *BalanceLotMutation) AddOriginalAmount(f float64) {
...
func (m *BalanceLotMutation) AddedOriginalAmount() (r float64, exists bool) {
...
func (m *BalanceLotMutation) ResetOriginalAmount() {
	m.original_amount = nil
	m.addoriginal_amount = nil
}

// SetRemainingAmount sets the "remaining_amount" field.
func (m *BalanceLotMutation) SetRemainingAmount(f float64) {
...
func (m *BalanceLotMutation) RemainingAmount() (r float64, exists bool) {
...
// OldRemainingAmount returns the old "remaining_amount" field's value of the BalanceLot entity.
// If the BalanceLot object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BalanceLotMutation) OldRemainingAmount(ctx context.Context) (v float64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *BalanceLotMutation) AddRemainingAmount(f float64) {
...
func (m *BalanceLotMutation) AddedRemainingAmount() (r float64, exists bool) {
...
func (m *BalanceLotMutation) ResetRemainingAmount() {
	m.remaining_amount = nil
	m.addremaining_amount = nil
}

// SetStatus sets the "status" field.
func (m *BalanceLotMutation) SetStatus(s string) {
	m.status = &s
}

// Status returns the value of the "status" field in the mutation.
func (m *BalanceLotMutation) Status() (r string, exists bool) {
	v := m.status
	if v == nil {
		return
	}
...
// OldStatus returns the old "status" field's value of the BalanceLot entity.
// If the BalanceLot object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BalanceLotMutation) OldStatus(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldStatus is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetStatus resets all changes to the "status" field.
func (m *BalanceLotMutation) ResetStatus() {
	m.status = nil
}

// SetExpiresAt sets the "expires_at" field.
func (m *BalanceLotMutation) SetExpiresAt(t time.Time) {
	m.expires_at = &t
}

// ExpiresAt returns the value of the "expires_at" field in the mutation.
func (m *BalanceLotMutation) ExpiresAt() (r time.Time, exists bool) {
	v := m.expires_at
	if v == nil {
		return
	}
...
// OldExpiresAt returns the old "expires_at" field's value of the BalanceLot entity.
// If the BalanceLot object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BalanceLotMutation) OldExpiresAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldExpiresAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetExpiresAt resets all changes to the "expires_at" field.
func (m *BalanceLotMutation) ResetExpiresAt() {
	m.expires_at = nil
}

// SetExpiredAt sets the "expired_at" field.
func (m *BalanceLotMutation) SetExpiredAt(t time.Time) {
	m.expired_at = &t
}

// ExpiredAt returns the value of the "expired_at" field in the mutation.
func (m *BalanceLotMutation) ExpiredAt() (r time.Time, exists bool) {
	v := m.expired_at
	if v == nil {
		return
	}
...
// OldExpiredAt returns the old "expired_at" field's value of the BalanceLot entity.
// If the BalanceLot object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BalanceLotMutation) OldExpiredAt(ctx context.Context) (v *time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *BalanceLotMutation) ClearExpiredAt() {
	m.expired_at = nil
	m.clearedFields[balancelot.FieldExpiredAt] = struct{}{}
}

// ExpiredAtCleared returns if the "expired_at" field was cleared in this mutation.
func (m *BalanceLotMutation) ExpiredAtCleared() bool {
	_, ok := m.clearedFields[balancelot.FieldExpiredAt]
	return ok
}

// ResetExpiredAt resets all changes to the "expired_at" field.
func (m *BalanceLotMutation) ResetExpiredAt() {
	m.expired_at = nil
	delete(m.clearedFields, balancelot.FieldExpiredAt)
}

// SetDescription sets the "description" field.
func (m *BalanceLotMutation) SetDescription(s string) {
	m.description = &s
}

// Description returns the value of the "description" field in the mutation.
func (m *BalanceLotMutation) Description() (r string, exists bool) {
	v := m.description
	if v == nil {
		return
	}
...
// OldDescription returns the old "description" field's value of the BalanceLot entity.
// If the BalanceLot object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BalanceLotMutation) OldDescription(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDescription is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetDescription resets all changes to the "description" field.
func (m *BalanceLotMutation) ResetDescription() {
	m.description = nil
}

// ClearUser clears the "user" edge to the User entity.
func (m *BalanceLotMutation) ClearUser() {
	m.cleareduser = true
	m.clearedFields[balancelot.FieldUserID] = struct{}{}
}

// UserCleared reports if the "user" edge to the User entity was cleared.
func (m *BalanceLotMutation) UserCleared() bool {
	return m.cleareduser
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// UserID instead. It exists only for internal usage by the builders.
func (m *BalanceLotMutation) UserIDs() (ids []int64) {
	if id := m.user; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetUser resets all changes to the "user" edge.
func (m *BalanceLotMutation) ResetUser() {
	m.user = nil
	m.cleareduser = false
}

// Where appends a list predicates to the BalanceLotMutation builder.
func (m *BalanceLotMutation) Where(ps ...predicate.BalanceLot) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the BalanceLotMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *BalanceLotMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.BalanceLot, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *BalanceLotMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *BalanceLotMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (BalanceLot).
func (m *BalanceLotMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *BalanceLotMutation) Fields() []string {
	fields := make([]string, 0, 11)
	if m.created_at != nil {
		fields = append(fields, balancelot.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, balancelot.FieldUpdatedAt)
	}
	if m.user != nil {
		fields = append(fields, balancelot.FieldUserID)
	}
	if m.source_type != nil {
		fields = append(fields, balancelot.FieldSourceType)
	}
	if m.source_ref != nil {
		fields = append(fields, balancelot.FieldSourceRef)
	}
	if m.original_amount != nil {
		fields = append(fields, balancelot.FieldOriginalAmount)
	}
	if m.remaining_amount != nil {
		fields = append(fields, balancelot.FieldRemainingAmount)
	}
	if m.status != nil {
		fields = append(fields, balancelot.FieldStatus)
	}
	if m.expires_at != nil {
		fields = append(fields, balancelot.FieldExpiresAt)
	}
	if m.expired_at != nil {
		fields = append(fields, balancelot.FieldExpiredAt)
	}
	if m.description != nil {
		fields = append(fields, balancelot.FieldDescription)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *BalanceLotMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *BalanceLotMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case balancelot.FieldCreatedAt:
		return m.OldCreatedAt(ctx)
	case balancelot.FieldUpdatedAt:
	...
	return nil, fmt.Errorf("unknown BalanceLot field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *BalanceLotMutation) SetField(name string, value ent.Value) error {
	switch name {
	case balancelot.FieldCreatedAt:
		v, ok := value.(time.Time)
		if !ok {
	...
	return fmt.Errorf("unknown BalanceLot field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *BalanceLotMutation) AddedFields() []string {
	var fields []string
	if m.addoriginal_amount != nil {
		fields = append(fields, balancelot.FieldOriginalAmount)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *BalanceLotMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case balancelot.FieldOriginalAmount:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *BalanceLotMutation) AddField(name string, value ent.Value) error {
	switch name {
	case balancelot.FieldOriginalAmount:
		v, ok := value.(float64)
		if !ok {
	...
	return fmt.Errorf("unknown BalanceLot numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *BalanceLotMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(balancelot.FieldSourceRef) {
		fields = append(fields, balancelot.FieldSourceRef)
	}
	if m.FieldCleared(balancelot.FieldExpiredAt) {
		fields = append(fields, balancelot.FieldExpiredAt)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *BalanceLotMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *BalanceLotMutation) ClearField(name string) error {
	switch name {
	case balancelot.FieldSourceRef:
		m.ClearSourceRef()
		return nil
	...
	return fmt.Errorf("unknown BalanceLot nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *BalanceLotMutation) ResetField(name string) error {
	switch name {
	case balancelot.FieldCreatedAt:
		m.ResetCreatedAt()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *BalanceLotMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.user != nil {
		edges = append(edges, balancelot.EdgeUser)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *BalanceLotMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case balancelot.EdgeUser:
		if id := m.user; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *BalanceLotMutation) RemovedEdges() []string {
	edges := make([]string, 0, 1)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *BalanceLotMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *BalanceLotMutation) ClearedEdges() []string {
	edges := make([]string, 0, 1)
	if m.cleareduser {
		edges = append(edges, balancelot.EdgeUser)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *BalanceLotMutation) EdgeCleared(name string) bool {
	switch name {
	case balancelot.EdgeUser:
		return m.cleareduser
	}
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *BalanceLotMutation) ClearEdge(name string) error {
	switch name {
	case balancelot.EdgeUser:
		m.ClearUser()
		return nil
	}
	return fmt.Errorf("unknown BalanceLot unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *BalanceLotMutation) ResetEdge(name string) error {
	switch name {
	case balancelot.EdgeUser:
		m.ResetUser()
		return nil
	}
	return fmt.Errorf("unknown BalanceLot edge %s", name)
}
...
type GroupMutation struct {
	...
	purchasable_description                 *string
	sort_order                              *int
	addsort_order                           *int
	clearedFields                           map[string]struct{}
	...
	removedusage_logs                       map[int64]struct{}
	clearedusage_logs                       bool
	subscription_orders                     map[int64]struct{}
	removedsubscription_orders              map[int64]struct{}
	clearedsubscription_orders              bool
...
func (m *GroupMutation) SetPriceCny(f float64) {
	m.price_cny = &f
	m.addprice_cny = nil
}

// PriceCny returns the value of the "price_cny" field in the mutation.
func (m *GroupMutation) PriceCny() (r float64, exists bool) {
	v := m.price_cny
	if v == nil {
		return
	}
...
// OldPriceCny returns the old "price_cny" field's value of the Group entity.
// If the Group object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *GroupMutation) OldPriceCny(ctx context.Context) (v *float64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *GroupMutation) AddPriceCny(f float64) {
...
func (m *GroupMutation) AddedPriceCny() (r float64, exists bool) {
	v := m.addprice_cny
	if v == nil {
		return
	}
...
func (m *GroupMutation) ClearPriceCny() {
	m.price_cny = nil
	m.addprice_cny = nil
	m.clearedFields[group.FieldPriceCny] = struct{}{}
}

// PriceCnyCleared returns if the "price_cny" field was cleared in this mutation.
func (m *GroupMutation) PriceCnyCleared() bool {
	_, ok := m.clearedFields[group.FieldPriceCny]
	return ok
}

// ResetPriceCny resets all changes to the "price_cny" field.
func (m *GroupMutation) ResetPriceCny() {
	m.price_cny = nil
	m.addprice_cny = nil
	delete(m.clearedFields, group.FieldPriceCny)
}

// SetDisplayOrder sets the "display_order" field.
func (m *GroupMutation) SetDisplayOrder(i int) {
	m.display_order = &i
	m.adddisplay_order = nil
}

// DisplayOrder returns the value of the "display_order" field in the mutation.
func (m *GroupMutation) DisplayOrder() (r int, exists bool) {
	v := m.display_order
	if v == nil {
		return
	}
...
// If the Group object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *GroupMutation) OldDisplayOrder(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *GroupMutation) AddDisplayOrder(i int) {
...
func (m *GroupMutation) AddedDisplayOrder() (r int, exists bool) {
...
func (m *GroupMutation) SetPurchasableDescription(s string) {
	m.purchasable_description = &s
}

// PurchasableDescription returns the value of the "purchasable_description" field in the mutation.
func (m *GroupMutation) PurchasableDescription() (r string, exists bool) {
	v := m.purchasable_description
	if v == nil {
		return
	}
	return *v, true
...
// OldPurchasableDescription returns the old "purchasable_description" field's value of the Group entity.
// If the Group object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *GroupMutation) OldPurchasableDescription(ctx context.Context) (v *string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldPurchasableDescription is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldPurchasableDescription requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldPurchasableDescription: %w", err)
	}
	return oldValue.PurchasableDescription, nil
}

// ClearPurchasableDescription clears the value of the "purchasable_description" field.
func (m *GroupMutation) ClearPurchasableDescription() {
	m.purchasable_description = nil
	m.clearedFields[group.FieldPurchasableDescription] = struct{}{}
}

// PurchasableDescriptionCleared returns if the "purchasable_description" field was cleared in this mutation.
func (m *GroupMutation) PurchasableDescriptionCleared() bool {
	_, ok := m.clearedFields[group.FieldPurchasableDescription]
	return ok
}

// ResetPurchasableDescription resets all changes to the "purchasable_description" field.
func (m *GroupMutation) ResetPurchasableDescription() {
	m.purchasable_description = nil
	delete(m.clearedFields, group.FieldPurchasableDescription)
}
...
func (m *GroupMutation) AddSubscriptionOrderIDs(ids ...int64) {
	if m.subscription_orders == nil {
		m.subscription_orders = make(map[int64]struct{})
	}
	for i := range ids {
		m.subscription_orders[ids[i]] = struct{}{}
	}
}

// ClearSubscriptionOrders clears the "subscription_orders" edge to the SubscriptionOrder entity.
func (m *GroupMutation) ClearSubscriptionOrders() {
	m.clearedsubscription_orders = true
}

// SubscriptionOrdersCleared reports if the "subscription_orders" edge to the SubscriptionOrder entity was cleared.
func (m *GroupMutation) SubscriptionOrdersCleared() bool {
	return m.clearedsubscription_orders
}

// RemoveSubscriptionOrderIDs removes the "subscription_orders" edge to the SubscriptionOrder entity by IDs.
func (m *GroupMutation) RemoveSubscriptionOrderIDs(ids ...int64) {
	if m.removedsubscription_orders == nil {
		m.removedsubscription_orders = make(map[int64]struct{})
	}
	for i := range ids {
		delete(m.subscription_orders, ids[i])
		m.removedsubscription_orders[ids[i]] = struct{}{}
	}
}

// RemovedSubscriptionOrders returns the removed IDs of the "subscription_orders" edge to the SubscriptionOrder entity.
func (m *GroupMutation) RemovedSubscriptionOrdersIDs() (ids []int64) {
	for id := range m.removedsubscription_orders {
		ids = append(ids, id)
	}
	return
}

// SubscriptionOrdersIDs returns the "subscription_orders" edge IDs in the mutation.
func (m *GroupMutation) SubscriptionOrdersIDs() (ids []int64) {
	for id := range m.subscription_orders {
		ids = append(ids, id)
	}
	return
}

// ResetSubscriptionOrders resets all changes to the "subscription_orders" edge.
func (m *GroupMutation) ResetSubscriptionOrders() {
	m.subscription_orders = nil
	m.clearedsubscription_orders = false
	m.removedsubscription_orders = nil
}
...
func (m *GroupMutation) Fields() []string {
	...
	if m.price_cny != nil {
		fields = append(fields, group.FieldPriceCny)
	}
	if m.display_order != nil {
		fields = append(fields, group.FieldDisplayOrder)
	}
	if m.purchasable_description != nil {
		fields = append(fields, group.FieldPurchasableDescription)
	}
	if m.sort_order != nil {
...
func (m *GroupMutation) Field(name string) (ent.Value, bool) {
	...
	case group.FieldPriceCny:
		return m.PriceCny()
	case group.FieldDisplayOrder:
		return m.DisplayOrder()
	case group.FieldPurchasableDescription:
		return m.PurchasableDescription()
...
func (m *GroupMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	case group.FieldPurchasableDescription:
		return m.OldPurchasableDescription(ctx)
	case group.FieldSortOrder:
...
func (m *GroupMutation) ClearedFields() []string {
	...
	if m.FieldCleared(group.FieldPriceCny) {
		fields = append(fields, group.FieldPriceCny)
	}
	if m.FieldCleared(group.FieldPurchasableDescription) {
		fields = append(fields, group.FieldPurchasableDescription)
	}
	return fields
}
...
func (m *GroupMutation) AddedEdges() []string {
	...
	if m.subscription_orders != nil {
		edges = append(edges, group.EdgeSubscriptionOrders)
	}
	if m.accounts != nil {
...
func (m *GroupMutation) AddedIDs(name string) []ent.Value {
	...
	case group.EdgeUsageLogs:
		...
		return ids
	case group.EdgeSubscriptionOrders:
		ids := make([]ent.Value, 0, len(m.subscription_orders))
		for id := range m.subscription_orders {
			ids = append(ids, id)
		}
		return ids
...
func (m *GroupMutation) RemovedIDs(name string) []ent.Value {
	...
	case group.EdgeUsageLogs:
		...
		return ids
	case group.EdgeSubscriptionOrders:
		ids := make([]ent.Value, 0, len(m.removedsubscription_orders))
		for id := range m.removedsubscription_orders {
			ids = append(ids, id)
		}
		return ids
...
func (m *GroupMutation) ClearedEdges() []string {
	...
	if m.clearedsubscription_orders {
		edges = append(edges, group.EdgeSubscriptionOrders)
	}
...
// SetPaymentMethod sets the "payment_method" field.
func (m *RechargeOrderMutation) SetPaymentMethod(s string) {
	m.payment_method = &s
}

// PaymentMethod returns the value of the "payment_method" field in the mutation.
func (m *RechargeOrderMutation) PaymentMethod() (r string, exists bool) {
	v := m.payment_method
	if v == nil {
		return
	}
...
// OldPaymentMethod returns the old "payment_method" field's value of the RechargeOrder entity.
// If the RechargeOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RechargeOrderMutation) OldPaymentMethod(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldPaymentMethod is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetPaymentMethod resets all changes to the "payment_method" field.
func (m *RechargeOrderMutation) ResetPaymentMethod() {
	m.payment_method = nil
}

// SetPaymentChannel sets the "payment_channel" field.
func (m *RechargeOrderMutation) SetPaymentChannel(s string) {
	m.payment_channel = &s
}

// PaymentChannel returns the value of the "payment_channel" field in the mutation.
func (m *RechargeOrderMutation) PaymentChannel() (r string, exists bool) {
	v := m.payment_channel
	if v == nil {
		return
	}
...
// OldPaymentChannel returns the old "payment_channel" field's value of the RechargeOrder entity.
// If the RechargeOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RechargeOrderMutation) OldPaymentChannel(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RechargeOrderMutation) ResetPaymentChannel() {
...
func (m *RechargeOrderMutation) SetWechatTransactionID(s string) {
	m.wechat_transaction_id = &s
}

// WechatTransactionID returns the value of the "wechat_transaction_id" field in the mutation.
func (m *RechargeOrderMutation) WechatTransactionID() (r string, exists bool) {
...
// OldWechatTransactionID returns the old "wechat_transaction_id" field's value of the RechargeOrder entity.
// If the RechargeOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RechargeOrderMutation) OldWechatTransactionID(ctx context.Context) (v *string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RechargeOrderMutation) ClearWechatTransactionID() {
	m.wechat_transaction_id = nil
	m.clearedFields[rechargeorder.FieldWechatTransactionID] = struct{}{}
}

// WechatTransactionIDCleared returns if the "wechat_transaction_id" field was cleared in this mutation.
func (m *RechargeOrderMutation) WechatTransactionIDCleared() bool {
	_, ok := m.clearedFields[rechargeorder.FieldWechatTransactionID]
	return ok
}

// ResetWechatTransactionID resets all changes to the "wechat_transaction_id" field.
func (m *RechargeOrderMutation) ResetWechatTransactionID() {
	m.wechat_transaction_id = nil
	delete(m.clearedFields, rechargeorder.FieldWechatTransactionID)
}

// SetQrcodeURL sets the "qrcode_url" field.
func (m *RechargeOrderMutation) SetQrcodeURL(s string) {
	m.qrcode_url = &s
}

// QrcodeURL returns the value of the "qrcode_url" field in the mutation.
func (m *RechargeOrderMutation) QrcodeURL() (r string, exists bool) {
	v := m.qrcode_url
	if v == nil {
		return
	}
...
// OldQrcodeURL returns the old "qrcode_url" field's value of the RechargeOrder entity.
// If the RechargeOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RechargeOrderMutation) OldQrcodeURL(ctx context.Context) (v *string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RechargeOrderMutation) ClearQrcodeURL() {
	m.qrcode_url = nil
	m.clearedFields[rechargeorder.FieldQrcodeURL] = struct{}{}
}

// QrcodeURLCleared returns if the "qrcode_url" field was cleared in this mutation.
func (m *RechargeOrderMutation) QrcodeURLCleared() bool {
	_, ok := m.clearedFields[rechargeorder.FieldQrcodeURL]
	return ok
}

// ResetQrcodeURL resets all changes to the "qrcode_url" field.
func (m *RechargeOrderMutation) ResetQrcodeURL() {
	m.qrcode_url = nil
	delete(m.clearedFields, rechargeorder.FieldQrcodeURL)
}

// SetPrepayID sets the "prepay_id" field.
func (m *RechargeOrderMutation) SetPrepayID(s string) {
	m.prepay_id = &s
}

// PrepayID returns the value of the "prepay_id" field in the mutation.
func (m *RechargeOrderMutation) PrepayID() (r string, exists bool) {
	v := m.prepay_id
	if v == nil {
		return
	}
...
// OldPrepayID returns the old "prepay_id" field's value of the RechargeOrder entity.
// If the RechargeOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RechargeOrderMutation) OldPrepayID(ctx context.Context) (v *string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RechargeOrderMutation) ClearPrepayID() {
	m.prepay_id = nil
	m.clearedFields[rechargeorder.FieldPrepayID] = struct{}{}
}

// PrepayIDCleared returns if the "prepay_id" field was cleared in this mutation.
func (m *RechargeOrderMutation) PrepayIDCleared() bool {
	_, ok := m.clearedFields[rechargeorder.FieldPrepayID]
	return ok
}

// ResetPrepayID resets all changes to the "prepay_id" field.
func (m *RechargeOrderMutation) ResetPrepayID() {
	m.prepay_id = nil
	delete(m.clearedFields, rechargeorder.FieldPrepayID)
}

// SetExpireAt sets the "expire_at" field.
func (m *RechargeOrderMutation) SetExpireAt(t time.Time) {
	m.expire_at = &t
}

// ExpireAt returns the value of the "expire_at" field in the mutation.
func (m *RechargeOrderMutation) ExpireAt() (r time.Time, exists bool) {
	v := m.expire_at
	if v == nil {
		return
	}
...
// OldExpireAt returns the old "expire_at" field's value of the RechargeOrder entity.
// If the RechargeOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RechargeOrderMutation) OldExpireAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RechargeOrderMutation) ResetExpireAt() {
	m.expire_at = nil
}
...
// SetNotes sets the "notes" field.
func (m *RechargeOrderMutation) SetNotes(s string) {
	m.notes = &s
}

// Notes returns the value of the "notes" field in the mutation.
func (m *RechargeOrderMutation) Notes() (r string, exists bool) {
	v := m.notes
	if v == nil {
		return
	}
...
// OldNotes returns the old "notes" field's value of the RechargeOrder entity.
// If the RechargeOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RechargeOrderMutation) OldNotes(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldNotes is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetNotes resets all changes to the "notes" field.
func (m *RechargeOrderMutation) ResetNotes() {
	m.notes = nil
}
...
func (m *RechargeOrderMutation) Fields() []string {
	...
	if m.payment_method != nil {
		fields = append(fields, rechargeorder.FieldPaymentMethod)
	}
	if m.payment_channel != nil {
		fields = append(fields, rechargeorder.FieldPaymentChannel)
	}
	if m.status != nil {
		fields = append(fields, rechargeorder.FieldStatus)
	}
	if m.wechat_transaction_id != nil {
		fields = append(fields, rechargeorder.FieldWechatTransactionID)
	}
	if m.qrcode_url != nil {
		fields = append(fields, rechargeorder.FieldQrcodeURL)
	}
	if m.prepay_id != nil {
		fields = append(fields, rechargeorder.FieldPrepayID)
	}
	if m.expire_at != nil {
		fields = append(fields, rechargeorder.FieldExpireAt)
	}
	if m.paid_at != nil {
...
func (m *RechargeOrderMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(rechargeorder.FieldWechatTransactionID) {
		fields = append(fields, rechargeorder.FieldWechatTransactionID)
	}
	if m.FieldCleared(rechargeorder.FieldQrcodeURL) {
		fields = append(fields, rechargeorder.FieldQrcodeURL)
	}
	if m.FieldCleared(rechargeorder.FieldPrepayID) {
		fields = append(fields, rechargeorder.FieldPrepayID)
	}
...
// SubscriptionOrderMutation represents an operation that mutates the SubscriptionOrder nodes in the graph.
type SubscriptionOrderMutation struct {
	config
	op                        Op
	typ                       string
	id                        *int64
	...
	amount                    *float64
	addamount                 *float64
	source_subscription_id    *int64
	addsource_subscription_id *int64
	original_amount           *float64
	addoriginal_amount        *float64
...
var _ ent.Mutation = (*SubscriptionOrderMutation)(nil)

// subscriptionorderOption allows management of the mutation configuration using functional options.
type subscriptionorderOption func(*SubscriptionOrderMutation)

// newSubscriptionOrderMutation creates new mutation for the SubscriptionOrder entity.
func newSubscriptionOrderMutation(c config, op Op, opts ...subscriptionorderOption) *SubscriptionOrderMutation {
	m := &SubscriptionOrderMutation{
		config:        c,
		op:            op,
		typ:           TypeSubscriptionOrder,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withSubscriptionOrderID sets the ID field of the mutation.
func withSubscriptionOrderID(id int64) subscriptionorderOption {
	return func(m *SubscriptionOrderMutation) {
		var (
			err   error
			once  sync.Once
			value *SubscriptionOrder
		)
		m.oldValue = func(ctx context.Context) (*SubscriptionOrder, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().SubscriptionOrder.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withSubscriptionOrder sets the old SubscriptionOrder of the mutation.
func withSubscriptionOrder(node *SubscriptionOrder) subscriptionorderOption {
	return func(m *SubscriptionOrderMutation) {
		m.oldValue = func(context.Context) (*SubscriptionOrder, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m SubscriptionOrderMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m SubscriptionOrderMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *SubscriptionOrderMutation) ID() (id int64, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *SubscriptionOrderMutation) IDs(ctx context.Context) ([]int64, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().SubscriptionOrder.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreatedAt sets the "created_at" field.
func (m *SubscriptionOrderMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *SubscriptionOrderMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// SetUpdatedAt sets the "updated_at" field.
func (m *SubscriptionOrderMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *SubscriptionOrderMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// SetOrderNo sets the "order_no" field.
func (m *SubscriptionOrderMutation) SetOrderNo(s string) {
	m.order_no = &s
}

// OrderNo returns the value of the "order_no" field in the mutation.
func (m *SubscriptionOrderMutation) OrderNo() (r string, exists bool) {
	v := m.order_no
	if v == nil {
		return
	}
...
// OldOrderNo returns the old "order_no" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldOrderNo(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldOrderNo is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetOrderNo resets all changes to the "order_no" field.
func (m *SubscriptionOrderMutation) ResetOrderNo() {
	m.order_no = nil
}

// SetUserID sets the "user_id" field.
func (m *SubscriptionOrderMutation) SetUserID(i int64) {
	m.user = &i
}

// UserID returns the value of the "user_id" field in the mutation.
func (m *SubscriptionOrderMutation) UserID() (r int64, exists bool) {
	v := m.user
	if v == nil {
		return
	}
...
// OldUserID returns the old "user_id" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
...
// ResetUserID resets all changes to the "user_id" field.
func (m *SubscriptionOrderMutation) ResetUserID() {
	m.user = nil
}

// SetGroupID sets the "group_id" field.
func (m *SubscriptionOrderMutation) SetGroupID(i int64) {
	m.group = &i
}

// GroupID returns the value of the "group_id" field in the mutation.
func (m *SubscriptionOrderMutation) GroupID() (r int64, exists bool) {
	v := m.group
	if v == nil {
		return
	}
...
// OldGroupID returns the old "group_id" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldGroupID(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldGroupID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetGroupID resets all changes to the "group_id" field.
func (m *SubscriptionOrderMutation) ResetGroupID() {
	m.group = nil
}

// SetOrderType sets the "order_type" field.
func (m *SubscriptionOrderMutation) SetOrderType(s string) {
	m.order_type = &s
}

// OrderType returns the value of the "order_type" field in the mutation.
func (m *SubscriptionOrderMutation) OrderType() (r string, exists bool) {
	v := m.order_type
	if v == nil {
		return
	}
...
// OldOrderType returns the old "order_type" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldOrderType(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SubscriptionOrderMutation) ResetOrderType() {
	m.order_type = nil
}

// SetAmount sets the "amount" field.
func (m *SubscriptionOrderMutation) SetAmount(f float64) {
	m.amount = &f
	m.addamount = nil
}

// Amount returns the value of the "amount" field in the mutation.
func (m *SubscriptionOrderMutation) Amount() (r float64, exists bool) {
	v := m.amount
	if v == nil {
		return
	}
...
// OldAmount returns the old "amount" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldAmount(ctx context.Context) (v float64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldAmount is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddAmount adds f to the "amount" field.
func (m *SubscriptionOrderMutation) AddAmount(f float64) {
	if m.addamount != nil {
		*m.addamount += f
	} else {
		m.addamount = &f
...
// AddedAmount returns the value that was added to the "amount" field in this mutation.
func (m *SubscriptionOrderMutation) AddedAmount() (r float64, exists bool) {
	v := m.addamount
	if v == nil {
		return
	}
...
// ResetAmount resets all changes to the "amount" field.
func (m *SubscriptionOrderMutation) ResetAmount() {
	m.amount = nil
	m.addamount = nil
}

// SetSourceSubscriptionID sets the "source_subscription_id" field.
func (m *SubscriptionOrderMutation) SetSourceSubscriptionID(i int64) {
	m.source_subscription_id = &i
	m.addsource_subscription_id = nil
}

// SourceSubscriptionID returns the value of the "source_subscription_id" field in the mutation.
func (m *SubscriptionOrderMutation) SourceSubscriptionID() (r int64, exists bool) {
...
// OldSourceSubscriptionID returns the old "source_subscription_id" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldSourceSubscriptionID(ctx context.Context) (v *int64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// AddSourceSubscriptionID adds i to the "source_subscription_id" field.
func (m *SubscriptionOrderMutation) AddSourceSubscriptionID(i int64) {
	if m.addsource_subscription_id != nil {
		*m.addsource_subscription_id += i
	} else {
		m.addsource_subscription_id = &i
	}
}

// AddedSourceSubscriptionID returns the value that was added to the "source_subscription_id" field in this mutation.
func (m *SubscriptionOrderMutation) AddedSourceSubscriptionID() (r int64, exists bool) {
	v := m.addsource_subscription_id
	if v == nil {
		return
	}
	return *v, true
...
func (m *SubscriptionOrderMutation) ClearSourceSubscriptionID() {
	m.source_subscription_id = nil
	m.addsource_subscription_id = nil
	m.clearedFields[subscriptionorder.FieldSourceSubscriptionID] = struct{}{}
}

// SourceSubscriptionIDCleared returns if the "source_subscription_id" field was cleared in this mutation.
func (m *SubscriptionOrderMutation) SourceSubscriptionIDCleared() bool {
	_, ok := m.clearedFields[subscriptionorder.FieldSourceSubscriptionID]
	return ok
}

// ResetSourceSubscriptionID resets all changes to the "source_subscription_id" field.
func (m *SubscriptionOrderMutation) ResetSourceSubscriptionID() {
	m.source_subscription_id = nil
	m.addsource_subscription_id = nil
	delete(m.clearedFields, subscriptionorder.FieldSourceSubscriptionID)
}

// SetOriginalAmount sets the "original_amount" field.
func (m *SubscriptionOrderMutation) SetOriginalAmount(f float64) {
	m.original_amount = &f
	m.addoriginal_amount = nil
}

// OriginalAmount returns the value of the "original_amount" field in the mutation.
func (m *SubscriptionOrderMutation) OriginalAmount() (r float64, exists bool) {
	v := m.original_amount
	if v == nil {
		return
	}
...
// OldOriginalAmount returns the old "original_amount" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldOriginalAmount(ctx context.Context) (v *float64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldOriginalAmount is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddOriginalAmount adds f to the "original_amount" field.
func (m *SubscriptionOrderMutation) AddOriginalAmount(f float64) {
	if m.addoriginal_amount != nil {
		*m.addoriginal_amount += f
	} else {
		m.addoriginal_amount = &f
...
// AddedOriginalAmount returns the value that was added to the "original_amount" field in this mutation.
func (m *SubscriptionOrderMutation) AddedOriginalAmount() (r float64, exists bool) {
	v := m.addoriginal_amount
	if v == nil {
		return
	}
...
func (m *SubscriptionOrderMutation) ClearOriginalAmount() {
	m.original_amount = nil
	m.addoriginal_amount = nil
	m.clearedFields[subscriptionorder.FieldOriginalAmount] = struct{}{}
}

// OriginalAmountCleared returns if the "original_amount" field was cleared in this mutation.
func (m *SubscriptionOrderMutation) OriginalAmountCleared() bool {
	_, ok := m.clearedFields[subscriptionorder.FieldOriginalAmount]
	return ok
}

// ResetOriginalAmount resets all changes to the "original_amount" field.
func (m *SubscriptionOrderMutation) ResetOriginalAmount() {
	m.original_amount = nil
	m.addoriginal_amount = nil
	delete(m.clearedFields, subscriptionorder.FieldOriginalAmount)
}

// SetDiscountAmount sets the "discount_amount" field.
func (m *SubscriptionOrderMutation) SetDiscountAmount(f float64) {
	m.discount_amount = &f
	m.adddiscount_amount = nil
}

// DiscountAmount returns the value of the "discount_amount" field in the mutation.
func (m *SubscriptionOrderMutation) DiscountAmount() (r float64, exists bool) {
	v := m.discount_amount
	if v == nil {
		return
	}
...
// OldDiscountAmount returns the old "discount_amount" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldDiscountAmount(ctx context.Context) (v *float64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SubscriptionOrderMutation) AddDiscountAmount(f float64) {
...
func (m *SubscriptionOrderMutation) AddedDiscountAmount() (r float64, exists bool) {
...
func (m *SubscriptionOrderMutation) ClearDiscountAmount() {
	m.discount_amount = nil
	m.adddiscount_amount = nil
	m.clearedFields[subscriptionorder.FieldDiscountAmount] = struct{}{}
}

// DiscountAmountCleared returns if the "discount_amount" field was cleared in this mutation.
func (m *SubscriptionOrderMutation) DiscountAmountCleared() bool {
	_, ok := m.clearedFields[subscriptionorder.FieldDiscountAmount]
	return ok
}

// ResetDiscountAmount resets all changes to the "discount_amount" field.
func (m *SubscriptionOrderMutation) ResetDiscountAmount() {
	m.discount_amount = nil
	m.adddiscount_amount = nil
	delete(m.clearedFields, subscriptionorder.FieldDiscountAmount)
}

// SetValidityDays sets the "validity_days" field.
func (m *SubscriptionOrderMutation) SetValidityDays(i int) {
	m.validity_days = &i
	m.addvalidity_days = nil
}

// ValidityDays returns the value of the "validity_days" field in the mutation.
func (m *SubscriptionOrderMutation) ValidityDays() (r int, exists bool) {
	v := m.validity_days
	if v == nil {
		return
	}
...
// OldValidityDays returns the old "validity_days" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldValidityDays(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldValidityDays is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddValidityDays adds i to the "validity_days" field.
func (m *SubscriptionOrderMutation) AddValidityDays(i int) {
	if m.addvalidity_days != nil {
		*m.addvalidity_days += i
	} else {
		m.addvalidity_days = &i
...
// AddedValidityDays returns the value that was added to the "validity_days" field in this mutation.
func (m *SubscriptionOrderMutation) AddedValidityDays() (r int, exists bool) {
	v := m.addvalidity_days
	if v == nil {
		return
	}
...
// ResetValidityDays resets all changes to the "validity_days" field.
func (m *SubscriptionOrderMutation) ResetValidityDays() {
	m.validity_days = nil
	m.addvalidity_days = nil
}

// SetPaymentMethod sets the "payment_method" field.
func (m *SubscriptionOrderMutation) SetPaymentMethod(s string) {
	m.payment_method = &s
}

// PaymentMethod returns the value of the "payment_method" field in the mutation.
func (m *SubscriptionOrderMutation) PaymentMethod() (r string, exists bool) {
	v := m.payment_method
	if v == nil {
		return
	}
...
// OldPaymentMethod returns the old "payment_method" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldPaymentMethod(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldPaymentMethod is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetPaymentMethod resets all changes to the "payment_method" field.
func (m *SubscriptionOrderMutation) ResetPaymentMethod() {
	m.payment_method = nil
}

// SetPaymentChannel sets the "payment_channel" field.
func (m *SubscriptionOrderMutation) SetPaymentChannel(s string) {
	m.payment_channel = &s
}

// PaymentChannel returns the value of the "payment_channel" field in the mutation.
func (m *SubscriptionOrderMutation) PaymentChannel() (r string, exists bool) {
	v := m.payment_channel
	if v == nil {
		return
	}
...
// OldPaymentChannel returns the old "payment_channel" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldPaymentChannel(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldPaymentChannel is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetPaymentChannel resets all changes to the "payment_channel" field.
func (m *SubscriptionOrderMutation) ResetPaymentChannel() {
	m.payment_channel = nil
}

// SetStatus sets the "status" field.
func (m *SubscriptionOrderMutation) SetStatus(s string) {
	m.status = &s
}

// Status returns the value of the "status" field in the mutation.
func (m *SubscriptionOrderMutation) Status() (r string, exists bool) {
	v := m.status
	if v == nil {
		return
	}
...
// OldStatus returns the old "status" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldStatus(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldStatus is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetStatus resets all changes to the "status" field.
func (m *SubscriptionOrderMutation) ResetStatus() {
	m.status = nil
}

// SetWechatTransactionID sets the "wechat_transaction_id" field.
func (m *SubscriptionOrderMutation) SetWechatTransactionID(s string) {
	m.wechat_transaction_id = &s
}

// WechatTransactionID returns the value of the "wechat_transaction_id" field in the mutation.
func (m *SubscriptionOrderMutation) WechatTransactionID() (r string, exists bool) {
	v := m.wechat_transaction_id
	if v == nil {
		return
	}
...
// OldWechatTransactionID returns the old "wechat_transaction_id" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldWechatTransactionID(ctx context.Context) (v *string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldWechatTransactionID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearWechatTransactionID clears the value of the "wechat_transaction_id" field.
func (m *SubscriptionOrderMutation) ClearWechatTransactionID() {
	m.wechat_transaction_id = nil
	m.clearedFields[subscriptionorder.FieldWechatTransactionID] = struct{}{}
}

// WechatTransactionIDCleared returns if the "wechat_transaction_id" field was cleared in this mutation.
func (m *SubscriptionOrderMutation) WechatTransactionIDCleared() bool {
	_, ok := m.clearedFields[subscriptionorder.FieldWechatTransactionID]
	return ok
}

// ResetWechatTransactionID resets all changes to the "wechat_transaction_id" field.
func (m *SubscriptionOrderMutation) ResetWechatTransactionID() {
	m.wechat_transaction_id = nil
	delete(m.clearedFields, subscriptionorder.FieldWechatTransactionID)
}

// SetQrcodeURL sets the "qrcode_url" field.
func (m *SubscriptionOrderMutation) SetQrcodeURL(s string) {
	m.qrcode_url = &s
}

// QrcodeURL returns the value of the "qrcode_url" field in the mutation.
func (m *SubscriptionOrderMutation) QrcodeURL() (r string, exists bool) {
	v := m.qrcode_url
	if v == nil {
		return
	}
...
// OldQrcodeURL returns the old "qrcode_url" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldQrcodeURL(ctx context.Context) (v *string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldQrcodeURL is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearQrcodeURL clears the value of the "qrcode_url" field.
func (m *SubscriptionOrderMutation) ClearQrcodeURL() {
	m.qrcode_url = nil
	m.clearedFields[subscriptionorder.FieldQrcodeURL] = struct{}{}
}

// QrcodeURLCleared returns if the "qrcode_url" field was cleared in this mutation.
func (m *SubscriptionOrderMutation) QrcodeURLCleared() bool {
	_, ok := m.clearedFields[subscriptionorder.FieldQrcodeURL]
	return ok
}

// ResetQrcodeURL resets all changes to the "qrcode_url" field.
func (m *SubscriptionOrderMutation) ResetQrcodeURL() {
	m.qrcode_url = nil
	delete(m.clearedFields, subscriptionorder.FieldQrcodeURL)
}

// SetPrepayID sets the "prepay_id" field.
func (m *SubscriptionOrderMutation) SetPrepayID(s string) {
	m.prepay_id = &s
}

// PrepayID returns the value of the "prepay_id" field in the mutation.
func (m *SubscriptionOrderMutation) PrepayID() (r string, exists bool) {
	v := m.prepay_id
	if v == nil {
		return
	}
...
// OldPrepayID returns the old "prepay_id" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldPrepayID(ctx context.Context) (v *string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldPrepayID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearPrepayID clears the value of the "prepay_id" field.
func (m *SubscriptionOrderMutation) ClearPrepayID() {
	m.prepay_id = nil
	m.clearedFields[subscriptionorder.FieldPrepayID] = struct{}{}
}

// PrepayIDCleared returns if the "prepay_id" field was cleared in this mutation.
func (m *SubscriptionOrderMutation) PrepayIDCleared() bool {
	_, ok := m.clearedFields[subscriptionorder.FieldPrepayID]
	return ok
}

// ResetPrepayID resets all changes to the "prepay_id" field.
func (m *SubscriptionOrderMutation) ResetPrepayID() {
	m.prepay_id = nil
	delete(m.clearedFields, subscriptionorder.FieldPrepayID)
}

// SetExpireAt sets the "expire_at" field.
func (m *SubscriptionOrderMutation) SetExpireAt(t time.Time) {
	m.expire_at = &t
}

// ExpireAt returns the value of the "expire_at" field in the mutation.
func (m *SubscriptionOrderMutation) ExpireAt() (r time.Time, exists bool) {
	v := m.expire_at
	if v == nil {
		return
	}
...
// OldExpireAt returns the old "expire_at" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldExpireAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldExpireAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetExpireAt resets all changes to the "expire_at" field.
func (m *SubscriptionOrderMutation) ResetExpireAt() {
	m.expire_at = nil
}

// SetPaidAt sets the "paid_at" field.
func (m *SubscriptionOrderMutation) SetPaidAt(t time.Time) {
	m.paid_at = &t
}

// PaidAt returns the value of the "paid_at" field in the mutation.
func (m *SubscriptionOrderMutation) PaidAt() (r time.Time, exists bool) {
	v := m.paid_at
	if v == nil {
		return
	}
...
// OldPaidAt returns the old "paid_at" field's value of the SubscriptionOrder entity.
// If the SubscriptionOrder object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscriptionOrderMutation) OldPaidAt(ctx context.Context) (v *time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldPaidAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearPaidAt clears the value of the "paid_at" field.
func (m *SubscriptionOrderMutation) ClearPaidAt() {
	m.paid_at = nil
	m.clearedFields[subscriptionorder.FieldPaidAt] = struct{}{}
}

// PaidAtCleared returns if the "paid_at" field was cleared in this mutation.
func (m *SubscriptionOrderMutation) PaidAtCleared() bool {
	_, ok := m.clearedFields[subscriptionorder.FieldPaidAt]
	return ok
}

// ResetPaidAt resets all changes to the "paid_at" field.
func (m *SubscriptionOrderMutation) ResetPaidAt() {
	m.paid_at = nil
	delete(m.clearedFields, subscriptionorder.FieldPaidAt)
}

// ClearUser clears the "user" edge to the User entity.
func (m *SubscriptionOrderMutation) ClearUser() {
	m.cleareduser = true
	m.clearedFields[subscriptionorder.FieldUserID] = struct{}{}
}

// UserCleared reports if the "user" edge to the User entity was cleared.
func (m *SubscriptionOrderMutation) UserCleared() bool {
	return m.cleareduser
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// UserID instead. It exists only for internal usage by the builders.
func (m *SubscriptionOrderMutation) UserIDs() (ids []int64) {
	if id := m.user; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetUser resets all changes to the "user" edge.
func (m *SubscriptionOrderMutation) ResetUser() {
	m.user = nil
	m.cleareduser = false
}

// ClearGroup clears the "group" edge to the Group entity.
func (m *SubscriptionOrderMutation) ClearGroup() {
	m.clearedgroup = true
	m.clearedFields[subscriptionorder.FieldGroupID] = struct{}{}
}

// GroupCleared reports if the "group" edge to the Group entity was cleared.
func (m *SubscriptionOrderMutation) GroupCleared() bool {
	return m.clearedgroup
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// GroupID instead. It exists only for internal usage by the builders.
func (m *SubscriptionOrderMutation) GroupIDs() (ids []int64) {
	if id := m.group; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetGroup resets all changes to the "group" edge.
func (m *SubscriptionOrderMutation) ResetGroup() {
	m.group = nil
	m.clearedgroup = false
}

// Where appends a list predicates to the SubscriptionOrderMutation builder.
func (m *SubscriptionOrderMutation) Where(ps ...predicate.SubscriptionOrder) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the SubscriptionOrderMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *SubscriptionOrderMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.SubscriptionOrder, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *SubscriptionOrderMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *SubscriptionOrderMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (SubscriptionOrder).
func (m *SubscriptionOrderMutation) Type() string {
	return m.typ
}
...
func (m *SubscriptionOrderMutation) Fields() []string {
	...
	if m.order_no != nil {
		fields = append(fields, subscriptionorder.FieldOrderNo)
	}
	if m.user != nil {
		fields = append(fields, subscriptionorder.FieldUserID)
	}
	if m.group != nil {
		fields = append(fields, subscriptionorder.FieldGroupID)
	}
	if m.order_type != nil {
		fields = append(fields, subscriptionorder.FieldOrderType)
	}
	if m.amount != nil {
		fields = append(fields, subscriptionorder.FieldAmount)
	}
	if m.source_subscription_id != nil {
		fields = append(fields, subscriptionorder.FieldSourceSubscriptionID)
	}
	if m.original_amount != nil {
		fields = append(fields, subscriptionorder.FieldOriginalAmount)
	}
	if m.discount_amount != nil {
		fields = append(fields, subscriptionorder.FieldDiscountAmount)
	}
	if m.validity_days != nil {
		fields = append(fields, subscriptionorder.FieldValidityDays)
	}
	if m.payment_method != nil {
		fields = append(fields, subscriptionorder.FieldPaymentMethod)
	}
	if m.payment_channel != nil {
		fields = append(fields, subscriptionorder.FieldPaymentChannel)
	}
	if m.status != nil {
		fields = append(fields, subscriptionorder.FieldStatus)
	}
	if m.wechat_transaction_id != nil {
		fields = append(fields, subscriptionorder.FieldWechatTransactionID)
	}
	if m.qrcode_url != nil {
		fields = append(fields, subscriptionorder.FieldQrcodeURL)
	}
	if m.prepay_id != nil {
		fields = append(fields, subscriptionorder.FieldPrepayID)
	}
	if m.expire_at != nil {
		fields = append(fields, subscriptionorder.FieldExpireAt)
	}
	if m.paid_at != nil {
		fields = append(fields, subscriptionorder.FieldPaidAt)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *SubscriptionOrderMutation) Field(name string) (ent.Value, bool) {
	switch name {
	...
	case subscriptionorder.FieldGroupID:
		return m.GroupID()
	case subscriptionorder.FieldOrderType:
		return m.OrderType()
	case subscriptionorder.FieldAmount:
		return m.Amount()
	case subscriptionorder.FieldSourceSubscriptionID:
		return m.SourceSubscriptionID()
	case subscriptionorder.FieldOriginalAmount:
		return m.OriginalAmount()
	...
	case subscriptionorder.FieldPaymentMethod:
		return m.PaymentMethod()
	case subscriptionorder.FieldPaymentChannel:
		return m.PaymentChannel()
	case subscriptionorder.FieldStatus:
		return m.Status()
	case subscriptionorder.FieldWechatTransactionID:
		return m.WechatTransactionID()
	case subscriptionorder.FieldQrcodeURL:
		return m.QrcodeURL()
	case subscriptionorder.FieldPrepayID:
		return m.PrepayID()
	case subscriptionorder.FieldExpireAt:
		return m.ExpireAt()
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *SubscriptionOrderMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case subscriptionorder.FieldCreatedAt:
		return m.OldCreatedAt(ctx)
	case subscriptionorder.FieldUpdatedAt:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SubscriptionOrderMutation) SetField(name string, value ent.Value) error {
	switch name {
	case subscriptionorder.FieldCreatedAt:
		v, ok := value.(time.Time)
		if !ok {
...
func (m *SubscriptionOrderMutation) AddedField(name string) (ent.Value, bool) {
	...
	case subscriptionorder.FieldAmount:
		return m.AddedAmount()
	case subscriptionorder.FieldSourceSubscriptionID:
		return m.AddedSourceSubscriptionID()
	case subscriptionorder.FieldOriginalAmount:
		return m.AddedOriginalAmount()
	case subscriptionorder.FieldDiscountAmount:
...
// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *SubscriptionOrderMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(subscriptionorder.FieldSourceSubscriptionID) {
		fields = append(fields, subscriptionorder.FieldSourceSubscriptionID)
	}
	if m.FieldCleared(subscriptionorder.FieldOriginalAmount) {
		fields = append(fields, subscriptionorder.FieldOriginalAmount)
	}
	if m.FieldCleared(subscriptionorder.FieldDiscountAmount) {
		fields = append(fields, subscriptionorder.FieldDiscountAmount)
	}
	if m.FieldCleared(subscriptionorder.FieldWechatTransactionID) {
		fields = append(fields, subscriptionorder.FieldWechatTransactionID)
	}
	if m.FieldCleared(subscriptionorder.FieldQrcodeURL) {
		fields = append(fields, subscriptionorder.FieldQrcodeURL)
	}
	if m.FieldCleared(subscriptionorder.FieldPrepayID) {
		fields = append(fields, subscriptionorder.FieldPrepayID)
	}
	if m.FieldCleared(subscriptionorder.FieldPaidAt) {
		fields = append(fields, subscriptionorder.FieldPaidAt)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *SubscriptionOrderMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *SubscriptionOrderMutation) ClearField(name string) error {
	switch name {
	case subscriptionorder.FieldSourceSubscriptionID:
...
// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *SubscriptionOrderMutation) ResetField(name string) error {
	switch name {
	case subscriptionorder.FieldCreatedAt:
		m.ResetCreatedAt()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *SubscriptionOrderMutation) AddedEdges() []string {
	edges := make([]string, 0, 2)
	if m.user != nil {
		edges = append(edges, subscriptionorder.EdgeUser)
	}
	if m.group != nil {
		edges = append(edges, subscriptionorder.EdgeGroup)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *SubscriptionOrderMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case subscriptionorder.EdgeUser:
		if id := m.user; id != nil {
			return []ent.Value{*id}
		}
	case subscriptionorder.EdgeGroup:
		if id := m.group; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *SubscriptionOrderMutation) RemovedEdges() []string {
	edges := make([]string, 0, 2)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *SubscriptionOrderMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *SubscriptionOrderMutation) ClearedEdges() []string {
	edges := make([]string, 0, 2)
	if m.cleareduser {
		edges = append(edges, subscriptionorder.EdgeUser)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *SubscriptionOrderMutation) EdgeCleared(name string) bool {
	switch name {
	case subscriptionorder.EdgeUser:
		return m.cleareduser
	case subscriptionorder.EdgeGroup:
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *SubscriptionOrderMutation) ClearEdge(name string) error {
	switch name {
	case subscriptionorder.EdgeUser:
		m.ClearUser()
		return nil
	...
	return fmt.Errorf("unknown SubscriptionOrder unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *SubscriptionOrderMutation) ResetEdge(name string) error {
	switch name {
	case subscriptionorder.EdgeUser:
		m.ResetUser()
		return nil
	...
	return fmt.Errorf("unknown SubscriptionOrder edge %s", name)
}
...
type UserMutation struct {
	...
	balance_lots                  map[int64]struct{}
	removedbalance_lots           map[int64]struct{}
	clearedbalance_lots           bool
...
func (m *UserMutation) AddBalanceLotIDs(ids ...int64) {
	if m.balance_lots == nil {
		m.balance_lots = make(map[int64]struct{})
	}
	for i := range ids {
		m.balance_lots[ids[i]] = struct{}{}
	}
}

// ClearBalanceLots clears the "balance_lots" edge to the BalanceLot entity.
func (m *UserMutation) ClearBalanceLots() {
	m.clearedbalance_lots = true
}

// BalanceLotsCleared reports if the "balance_lots" edge to the BalanceLot entity was cleared.
func (m *UserMutation) BalanceLotsCleared() bool {
	return m.clearedbalance_lots
}

// RemoveBalanceLotIDs removes the "balance_lots" edge to the BalanceLot entity by IDs.
func (m *UserMutation) RemoveBalanceLotIDs(ids ...int64) {
	if m.removedbalance_lots == nil {
		m.removedbalance_lots = make(map[int64]struct{})
	}
	for i := range ids {
		delete(m.balance_lots, ids[i])
		m.removedbalance_lots[ids[i]] = struct{}{}
	}
}

// RemovedBalanceLots returns the removed IDs of the "balance_lots" edge to the BalanceLot entity.
func (m *UserMutation) RemovedBalanceLotsIDs() (ids []int64) {
	for id := range m.removedbalance_lots {
		ids = append(ids, id)
	}
	return
}

// BalanceLotsIDs returns the "balance_lots" edge IDs in the mutation.
func (m *UserMutation) BalanceLotsIDs() (ids []int64) {
	for id := range m.balance_lots {
		ids = append(ids, id)
	}
	return
}

// ResetBalanceLots resets all changes to the "balance_lots" edge.
func (m *UserMutation) ResetBalanceLots() {
	m.balance_lots = nil
	m.clearedbalance_lots = false
	m.removedbalance_lots = nil
}
...
// AddSubscriptionOrderIDs adds the "subscription_orders" edge to the SubscriptionOrder entity by ids.
func (m *UserMutation) AddSubscriptionOrderIDs(ids ...int64) {
	if m.subscription_orders == nil {
		m.subscription_orders = make(map[int64]struct{})
	}
	for i := range ids {
...
// ClearSubscriptionOrders clears the "subscription_orders" edge to the SubscriptionOrder entity.
func (m *UserMutation) ClearSubscriptionOrders() {
	m.clearedsubscription_orders = true
}

// SubscriptionOrdersCleared reports if the "subscription_orders" edge to the SubscriptionOrder entity was cleared.
func (m *UserMutation) SubscriptionOrdersCleared() bool {
	return m.clearedsubscription_orders
}

// RemoveSubscriptionOrderIDs removes the "subscription_orders" edge to the SubscriptionOrder entity by IDs.
func (m *UserMutation) RemoveSubscriptionOrderIDs(ids ...int64) {
	if m.removedsubscription_orders == nil {
		m.removedsubscription_orders = make(map[int64]struct{})
	}
	for i := range ids {
...
// RemovedSubscriptionOrders returns the removed IDs of the "subscription_orders" edge to the SubscriptionOrder entity.
func (m *UserMutation) RemovedSubscriptionOrdersIDs() (ids []int64) {
	for id := range m.removedsubscription_orders {
		ids = append(ids, id)
	}
	return
...
// SubscriptionOrdersIDs returns the "subscription_orders" edge IDs in the mutation.
func (m *UserMutation) SubscriptionOrdersIDs() (ids []int64) {
	for id := range m.subscription_orders {
		ids = append(ids, id)
	}
	return
...
// ResetSubscriptionOrders resets all changes to the "subscription_orders" edge.
func (m *UserMutation) ResetSubscriptionOrders() {
	m.subscription_orders = nil
	m.clearedsubscription_orders = false
	m.removedsubscription_orders = nil
}
...
func (m *UserMutation) AddedEdges() []string {
	...
	if m.balance_lots != nil {
		edges = append(edges, user.EdgeBalanceLots)
	}
	if m.recharge_orders != nil {
		edges = append(edges, user.EdgeRechargeOrders)
	}
	if m.subscription_orders != nil {
		edges = append(edges, user.EdgeSubscriptionOrders)
	}
	return edges
}
...
func (m *UserMutation) AddedIDs(name string) []ent.Value {
	...
	case user.EdgeBalanceLogs:
		...
		return ids
	case user.EdgeBalanceLots:
		ids := make([]ent.Value, 0, len(m.balance_lots))
		for id := range m.balance_lots {
			ids = append(ids, id)
		}
		return ids
	case user.EdgeRechargeOrders:
		...
		return ids
	case user.EdgeSubscriptionOrders:
		ids := make([]ent.Value, 0, len(m.subscription_orders))
		for id := range m.subscription_orders {
			ids = append(ids, id)
		}
...
func (m *UserMutation) RemovedIDs(name string) []ent.Value {
	...
	case user.EdgeBalanceLogs:
		...
		return ids
	case user.EdgeBalanceLots:
		ids := make([]ent.Value, 0, len(m.removedbalance_lots))
		for id := range m.removedbalance_lots {
			ids = append(ids, id)
		}
		return ids
